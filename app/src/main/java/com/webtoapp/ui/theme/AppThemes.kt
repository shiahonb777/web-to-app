...
enum class AppThemeType(
    ...
    AURORA("极光梦境", "北极光般流动的梦幻渐变，如置身极地夜空", "AutoAwesome"),
    CYBERPUNK("赛博霓虹", "霓虹闪烁的未来都市，科技与叛逆的交融", "ElectricBolt"),
    SAKURA("樱花物语", "粉色花瓣轻舞飞扬，日式和风的诗意美学", "FilterVintage"),
    OCEAN("深海幽蓝", "海洋深处的神秘光芒，波光粼粼的宁静", "Waves"),
    FOREST("森林晨曦", "阳光穿透树叶的斑驳，大自然的清新呼吸", "Forest"),
    GALAXY("星空银河", "浩瀚宇宙的璀璨星河，无垠深空的浪漫", "Stars"),
    VOLCANO("熔岩之心", "岩浆奔涌的炽热能量，燃烧的生命力", "Whatshot"),
    FROST("冰晶之境", "冰雪世界的纯净光辉，晶莹剔透的优雅", "AcUnit"),
    SUNSET("紫金黄昏", "落日余晖的温暖拥抱，黄昏时分的诗意", "WbTwilight"),
    MINIMAL("极简主义", "去繁就简的纯粹美学，精致细节的禅意", "Minimize"),
    NEON_TOKYO("东京霓虹", "雨夜东京的霓虹倒影，赛博朋克的浪漫", "Nightlife"),
    LAVENDER("薰衣草田", "普罗旺斯的紫色海洋，芬芳宁静的治愈", "Spa")
}
 ...
 * 交互反馈风格
 */
enum class InteractionStyle(val displayName: String) {
    RIPPLE("水波涟漪"),       // 经典水波
    GLOW("光晕扩散"),         // 发光效果
    SCALE("缩放脉冲"),        // 缩放反馈
    SHAKE("微震反馈"),        // 轻微震动
...
data class ThemeEffects(
    ...
    val enableParticles: Boolean,       // 是否启用粒子
    val enableGlow: Boolean,            // 是否启用发光
    val enableGlassmorphism: Boolean    // 是否启用玻璃拟态
)
...
data class ThemeShapes(
    ...
    val useRoundedButtons: Boolean,     // 是否使用圆形按钮
    val useSoftShadows: Boolean         // 是否使用柔和阴影
)
