...
data class Announcement(
    val title: String = "",
    val content: String = "",
    val linkUrl: String? = null,      // 内容区域的链接（兼容旧版）
    val linkText: String? = null,     // 内容区域的链接文本（兼容旧版）
    val buttonText: String? = null,   // 左侧按钮文本（如"加入官方群"）
    val buttonUrl: String? = null,    // 左侧按钮跳转链接
...
data class WebViewConfig(
    ...
    val autoTranslate: Boolean = false, // 自动翻译网页为中文
