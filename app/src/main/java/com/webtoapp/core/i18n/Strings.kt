...
object Strings {
    ...
    /**
     * 快速本地化帮助方法（中文/英文，阿拉伯语暂时回退中文）
     */
    fun localized(chinese: String, english: String, arabic: String? = null): String = when (lang) {
        AppLanguage.CHINESE -> chinese
        AppLanguage.ENGLISH -> english
        AppLanguage.ARABIC -> arabic ?: chinese
    }
    ...
    val downloadFailedTitle: String get() = when (lang) {
    ...
    val shortcutCreationFailedWithReason: String get() = when (lang) {
        AppLanguage.CHINESE -> "创建失败: %s"
        AppLanguage.ENGLISH -> "Creation failed: %s"
        AppLanguage.ARABIC -> "فشل الإنشاء: %s"
    }

    val shortcutLauncherNotSupported: String get() = when (lang) {
        AppLanguage.CHINESE -> "当前启动器不支持创建快捷方式，请尝试更换默认桌面或手动授权"
        AppLanguage.ENGLISH -> "The current launcher doesn't support creating shortcuts. Try switching to the default launcher or grant permissions manually."
        AppLanguage.ARABIC -> "لا يدعم المشغل الحالي إنشاء اختصارات. حاول تغيير المشغل الافتراضي أو منح الأذونات يدويًا."
    }

    val shortcutRequestSent: String get() = when (lang) {
        AppLanguage.CHINESE -> "快捷方式请求已发送，请检查桌面"
        AppLanguage.ENGLISH -> "Shortcut request sent, please check your home screen"
        AppLanguage.ARABIC -> "تم إرسال طلب الاختصار، يرجى التحقق من الشاشة الرئيسية"
    }

    val shortcutPermissionRetry: String get() = when (lang) {
        AppLanguage.CHINESE -> "请在应用设置中开启快捷方式权限后重试"
        AppLanguage.ENGLISH -> "Enable shortcut permissions in app settings and try again"
        AppLanguage.ARABIC -> "قم بتمكين أذونات الاختصار في إعدادات التطبيق وحاول مرة أخرى"
    }
    ...
    val lrcAnimationNone: String get() = when (lang) {
        AppLanguage.CHINESE -> "无动画"
        AppLanguage.ENGLISH -> "None"
        AppLanguage.ARABIC -> "无动画"
    }

    val lrcAnimationFade: String get() = when (lang) {
        AppLanguage.CHINESE -> "淡入淡出"
        AppLanguage.ENGLISH -> "Fade"
        AppLanguage.ARABIC -> "淡入淡出"
    }

    val lrcAnimationSlideUp: String get() = when (lang) {
        AppLanguage.CHINESE -> "向上滑动"
        AppLanguage.ENGLISH -> "Slide Up"
        AppLanguage.ARABIC -> "向上滑动"
    }

    val lrcAnimationSlideLeft: String get() = when (lang) {
        AppLanguage.CHINESE -> "向左滑动"
        AppLanguage.ENGLISH -> "Slide Left"
        AppLanguage.ARABIC -> "向左滑动"
    }

    val lrcAnimationScale: String get() = when (lang) {
        AppLanguage.CHINESE -> "缩放"
        AppLanguage.ENGLISH -> "Scale"
        AppLanguage.ARABIC -> "缩放"
    }

    val lrcAnimationTypewriter: String get() = when (lang) {
        AppLanguage.CHINESE -> "打字机"
        AppLanguage.ENGLISH -> "Typewriter"
        AppLanguage.ARABIC -> "打字机"
    }

    val lrcAnimationKaraoke: String get() = when (lang) {
        AppLanguage.CHINESE -> "卡拉OK高亮"
        AppLanguage.ENGLISH -> "Karaoke Highlight"
        AppLanguage.ARABIC -> "卡拉OK高亮"
    }

    val lrcPositionTop: String get() = when (lang) {
        AppLanguage.CHINESE -> "顶部"
        AppLanguage.ENGLISH -> "Top"
        AppLanguage.ARABIC -> "顶部"
    }

    val lrcPositionCenter: String get() = when (lang) {
        AppLanguage.CHINESE -> "居中"
        AppLanguage.ENGLISH -> "Center"
        AppLanguage.ARABIC -> "居中"
    }

    val lrcPositionBottom: String get() = when (lang) {
        AppLanguage.CHINESE -> "底部"
        AppLanguage.ENGLISH -> "Bottom"
        AppLanguage.ARABIC -> "底部"
    }
    ...
    val backupReadingAppData: String get() = when (lang) {
        AppLanguage.CHINESE -> "正在读取应用数据..."
        AppLanguage.ENGLISH -> "Reading app data..."
        AppLanguage.ARABIC -> "正在读取应用数据..."
    }

    val backupNoDataToExport: String get() = when (lang) {
        AppLanguage.CHINESE -> "没有可导出的应用数据"
        AppLanguage.ENGLISH -> "No app data available for export"
        AppLanguage.ARABIC -> "没有可导出的应用数据"
    }

    val backupCollectingResourcesFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "正在收集资源: %s"
        AppLanguage.ENGLISH -> "Collecting resources: %s"
        AppLanguage.ARABIC -> "正在收集资源: %s"
    }

    val backupCreatingFile: String get() = when (lang) {
        AppLanguage.CHINESE -> "正在创建备份文件..."
        AppLanguage.ENGLISH -> "Creating backup file..."
        AppLanguage.ARABIC -> "正在创建备份文件..."
    }

    val backupPackagingResources: String get() = when (lang) {
        AppLanguage.CHINESE -> "正在打包资源文件..."
        AppLanguage.ENGLISH -> "Packaging resource files..."
        AppLanguage.ARABIC -> "正在打包资源文件..."
    }

    val backupUnableToCreateOutput: String get() = when (lang) {
        AppLanguage.CHINESE -> "无法创建输出文件"
        AppLanguage.ENGLISH -> "Unable to create output file"
        AppLanguage.ARABIC -> "无法创建输出文件"
    }

    val backupExportComplete: String get() = when (lang) {
        AppLanguage.CHINESE -> "导出完成"
        AppLanguage.ENGLISH -> "Export complete"
        AppLanguage.ARABIC -> "导出完成"
    }

    val backupReadingFile: String get() = when (lang) {
        AppLanguage.CHINESE -> "正在读取备份文件..."
        AppLanguage.ENGLISH -> "Reading backup file..."
        AppLanguage.ARABIC -> "正在读取备份文件..."
    }

    val backupExtractingEntryFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "正在解压: %s"
        AppLanguage.ENGLISH -> "Extracting: %s"
        AppLanguage.ARABIC -> "正在解压: %s"
    }

    val backupUnableToReadFile: String get() = when (lang) {
        AppLanguage.CHINESE -> "无法读取备份文件"
        AppLanguage.ENGLISH -> "Unable to read backup file"
        AppLanguage.ARABIC -> "无法读取备份文件"
    }

    val backupInvalidFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "备份文件格式无效"
        AppLanguage.ENGLISH -> "Invalid backup file format"
        AppLanguage.ARABIC -> "备份文件格式无效"
    }

    val backupImportingAppData: String get() = when (lang) {
        AppLanguage.CHINESE -> "正在导入应用数据..."
        AppLanguage.ENGLISH -> "Importing app data..."
        AppLanguage.ARABIC -> "正在导入应用数据..."
    }

    val backupImportingAppFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "正在导入: %s"
        AppLanguage.ENGLISH -> "Importing: %s"
        AppLanguage.ARABIC -> "正在导入: %s"
    }

    val backupImportComplete: String get() = when (lang) {
        AppLanguage.CHINESE -> "导入完成"
        AppLanguage.ENGLISH -> "Import complete"
        AppLanguage.ARABIC -> "导入完成"
    }
    ...
    val ruleUseChineseConversation: String get() = when (lang) {
        AppLanguage.CHINESE -> "????????"
        AppLanguage.ENGLISH -> "Use Chinese for conversation"
        AppLanguage.ARABIC -> "Use Chinese for conversation"
    }

    val ruleUseChineseComments: String get() = when (lang) {
        AppLanguage.CHINESE -> "????????"
        AppLanguage.ENGLISH -> "Use Chinese for code comments"
        AppLanguage.ARABIC -> "Use Chinese for code comments"
    }

    val ruleGameFlowComplete: String get() = when (lang) {
        AppLanguage.CHINESE -> "?????????????????"
        AppLanguage.ENGLISH -> "Games should include a complete start, play, and end flow"
        AppLanguage.ARABIC -> "Games should include a complete start, play, and end flow"
    }

    val ruleGameScoreAndInstructions: String get() = when (lang) {
        AppLanguage.CHINESE -> "???????????"
        AppLanguage.ENGLISH -> "Add score display and game instructions"
        AppLanguage.ARABIC -> "Add score display and game instructions"
    }

    val ruleGameTouchSmooth: String get() = when (lang) {
        AppLanguage.CHINESE -> "????????"
        AppLanguage.ENGLISH -> "Ensure touch controls are smooth"
        AppLanguage.ARABIC -> "Ensure touch controls are smooth"
    }

    val ruleAnimationSmoothCss: String get() = when (lang) {
        AppLanguage.CHINESE -> "????? CSS ??"
        AppLanguage.ENGLISH -> "Add smooth CSS animations"
        AppLanguage.ARABIC -> "Add smooth CSS animations"
    }

    val ruleAnimationUseTransition: String get() = when (lang) {
        AppLanguage.CHINESE -> "?? transition ??????"
        AppLanguage.ENGLISH -> "Use transitions to improve interaction feedback"
        AppLanguage.ARABIC -> "Use transitions to improve interaction feedback"
    }

    val ruleAnimationPerformance: String get() = when (lang) {
        AppLanguage.CHINESE -> "???????????"
        AppLanguage.ENGLISH -> "Consider performance and avoid excessive animation"
        AppLanguage.ARABIC -> "Consider performance and avoid excessive animation"
    }

    val ruleFormValidation: String get() = when (lang) {
        AppLanguage.CHINESE -> "???????????"
        AppLanguage.ENGLISH -> "Forms should include complete validation logic"
        AppLanguage.ARABIC -> "Forms should include complete validation logic"
    }

    val ruleFormLabelsHints: String get() = when (lang) {
        AppLanguage.CHINESE -> "?????????????"
        AppLanguage.ENGLISH -> "Inputs should have clear labels and hints"
        AppLanguage.ARABIC -> "Inputs should have clear labels and hints"
    }

    val ruleFormSubmitLoading: String get() = when (lang) {
        AppLanguage.CHINESE -> "??????????"
        AppLanguage.ENGLISH -> "Submit buttons should show a loading state"
        AppLanguage.ARABIC -> "Submit buttons should show a loading state"
    }
    ...
    val encryptionLevelFast: String get() = when (lang) {
        AppLanguage.CHINESE -> "快速（较低安全性）"
        AppLanguage.ENGLISH -> "Fast (lower security)"
        AppLanguage.ARABIC -> "快速（较低安全性）"
    }

    val encryptionLevelStandard: String get() = when (lang) {
        AppLanguage.CHINESE -> "标准（推荐）"
        AppLanguage.ENGLISH -> "Standard (recommended)"
        AppLanguage.ARABIC -> "标准（推荐）"
    }

    val encryptionLevelHigh: String get() = when (lang) {
        AppLanguage.CHINESE -> "高强度（较慢）"
        AppLanguage.ENGLISH -> "High (slower)"
        AppLanguage.ARABIC -> "高强度（较慢）"
    }

    val encryptionLevelParanoid: String get() = when (lang) {
        AppLanguage.CHINESE -> "极高强度（很慢）"
        AppLanguage.ENGLISH -> "Paranoid (very slow)"
        AppLanguage.ARABIC -> "极高强度（很慢）"
    }
    ...
    fun projectDetectorDistDetected(distDirName: String): String = when (lang) {
        AppLanguage.CHINESE -> "检测到已构建的输出目录: $distDirName，可直接导入"
        AppLanguage.ENGLISH -> "Built output directory detected: $distDirName. You can import it directly."
        AppLanguage.ARABIC -> "Built output directory detected: $distDirName. You can import it directly."
    }

    val projectDetectorMissingPackageJson: String get() = when (lang) {
        AppLanguage.CHINESE -> "未找到 package.json 文件，也没有检测到静态文件"
        AppLanguage.ENGLISH -> "package.json not found and no static files were detected"
        AppLanguage.ARABIC -> "package.json not found and no static files were detected"
    }

    fun projectDetectorPackageJsonParseError(details: String): String = when (lang) {
        AppLanguage.CHINESE -> "package.json 格式错误: $details"
        AppLanguage.ENGLISH -> "package.json parse error: $details"
        AppLanguage.ARABIC -> "package.json parse error: $details"
    }

    val projectDetectorStaticIndexMissing: String get() = when (lang) {
        AppLanguage.CHINESE -> "未找到 index.html 文件"
        AppLanguage.ENGLISH -> "index.html file not found"
        AppLanguage.ARABIC -> "index.html file not found"
    }

    val projectDetectorStaticImportHint: String get() = when (lang) {
        AppLanguage.CHINESE -> "检测到静态网站项目，将直接导入所有文件"
        AppLanguage.ENGLISH -> "Static site detected; all files will be imported directly"
        AppLanguage.ARABIC -> "Static site detected; all files will be imported directly"
    }

    val projectDetectorMissingDistFolder: String get() = when (lang) {
        AppLanguage.CHINESE -> "未检测到构建输出目录（dist/build）"
        AppLanguage.ENGLISH -> "No build output directory (dist/build) was detected"
        AppLanguage.ARABIC -> "No build output directory (dist/build) was detected"
    }

    val projectDetectorBuildCommandSuggestion: String get() = when (lang) {
        AppLanguage.CHINESE -> "💡 请先在电脑上构建项目：npm run build"
        AppLanguage.ENGLISH -> "💡 Run `npm run build` on your computer first"
        AppLanguage.ARABIC -> "💡 Run `npm run build` on your computer first"
    }

    val projectDetectorChooseOutputHint: String get() = when (lang) {
        AppLanguage.CHINESE -> "💡 然后选择构建输出目录（通常是 dist 或 build）导入"
        AppLanguage.ENGLISH -> "💡 Then choose the build output folder (usually dist or build) to import"
        AppLanguage.ARABIC -> "💡 Then choose the build output folder (usually dist or build) to import"
    }

    val projectDetectorSsrExportHint: String get() = when (lang) {
        AppLanguage.CHINESE -> "⚠️ SSR 框架需要使用静态导出模式构建"
        AppLanguage.ENGLISH -> "⚠️ SSR frameworks require a static export build"
        AppLanguage.ARABIC -> "⚠️ SSR frameworks require a static export build"
    }

    val projectDetectorDatabaseWarning: String get() = when (lang) {
        AppLanguage.CHINESE -> "⚠️ 检测到数据库依赖，前端应用无法直接使用后端数据库"
        AppLanguage.ENGLISH -> "⚠️ Database dependencies were detected; frontend apps can’t access backend databases directly"
        AppLanguage.ARABIC -> "⚠️ Database dependencies were detected; frontend apps can’t access backend databases directly"
    }

    fun agentToolBracketMismatchMessage(kind: String, count: Int): String = when (lang) {
        AppLanguage.CHINESE -> {
            val direction = if (count > 0) "缺少 $count 个" else "多余 ${-count} 个"
            when (kind) {
                "brace" -> "大括号不匹配，$direction }"
                "paren" -> "小括号不匹配，$direction )"
                "bracket" -> "方括号不匹配，$direction ]"
                else -> "括号不匹配，$direction"
            }
        }
        AppLanguage.ENGLISH -> {
            val detail = if (count > 0) "missing $count" else "extra ${-count}"
            when (kind) {
                "brace" -> "Brace mismatch: $detail '}'"
                "paren" -> "Parenthesis mismatch: $detail ')'"
                "bracket" -> "Bracket mismatch: $detail ']'"
                else -> "Bracket mismatch: $detail"
            }
        }
        AppLanguage.ARABIC -> {
            val detail = if (count > 0) "missing $count" else "extra ${-count}"
    ...
    fun agentToolBracketMismatchSuggestion(kind: String): String = when (lang) {
        AppLanguage.CHINESE -> when (kind) {
            "brace" -> "检查所有 { } 是否正确配对"
            "paren" -> "检查所有 ( ) 是否正确配对"
            "bracket" -> "检查所有 [ ] 是否正确配对"
            else -> "检查所有括号配对"
        }
        AppLanguage.ENGLISH -> "Ensure all brackets are properly paired"
        AppLanguage.ARABIC -> "Ensure all brackets are properly paired"
    }

    val agentToolUseLetConstWarning: String get() = when (lang) {
        AppLanguage.CHINESE -> "建议使用 let 或 const 代替 var"
        AppLanguage.ENGLISH -> "Use let or const instead of var"
        AppLanguage.ARABIC -> "Use let or const instead of var"
    }

    val agentToolStrictEqualityWarning: String get() = when (lang) {
        AppLanguage.CHINESE -> "建议使用 === 代替 =="
        AppLanguage.ENGLISH -> "Use === instead of =="
        AppLanguage.ARABIC -> "Use === instead of =="
    }

    val agentToolAvoidEvalWarning: String get() = when (lang) {
        AppLanguage.CHINESE -> "避免使用 eval()，存在安全风险"
        AppLanguage.ENGLISH -> "Avoid using eval(); it poses security risks"
        AppLanguage.ARABIC -> "Avoid using eval(); it poses security risks"
    }

    val agentToolDocumentWriteWarning: String get() = when (lang) {
        AppLanguage.CHINESE -> "避免使用 document.write()，可能导致页面问题"
        AppLanguage.ENGLISH -> "Avoid document.write(); it can break the page"
        AppLanguage.ARABIC -> "Avoid document.write(); it can break the page"
    }

    val agentToolConsoleLogWarning: String get() = when (lang) {
        AppLanguage.CHINESE -> "生产代码中建议移除 console.log"
        AppLanguage.ENGLISH -> "Remove console.log statements in production code"
        AppLanguage.ARABIC -> "Remove console.log statements in production code"
    }

    val agentToolCssMissingSemicolonWarning: String get() = when (lang) {
        AppLanguage.CHINESE -> "CSS 属性可能缺少分号"
        AppLanguage.ENGLISH -> "Possible missing semicolon in CSS declaration"
        AppLanguage.ARABIC -> "Possible missing semicolon in CSS declaration"
    }

    val agentToolAvoidImportantWarning: String get() = when (lang) {
        AppLanguage.CHINESE -> "尽量避免过度使用 !important"
        AppLanguage.ENGLISH -> "Avoid excessive use of !important"
        AppLanguage.ARABIC -> "Avoid excessive use of !important"
    }

    val agentToolCssBraceMismatch: String get() = when (lang) {
        AppLanguage.CHINESE -> "大括号不匹配"
        AppLanguage.ENGLISH -> "Brace mismatch detected"
        AppLanguage.ARABIC -> "Brace mismatch detected"
    }

    val agentToolStrictModeSuggestion: String get() = when (lang) {
        AppLanguage.CHINESE -> "建议在代码开头添加 'use strict' 启用严格模式"
        AppLanguage.ENGLISH -> "Add 'use strict' at the top of the file"
        AppLanguage.ARABIC -> "Add 'use strict' at the top of the file"
    }

    val agentToolArrowFunctionSuggestion: String get() = when (lang) {
        AppLanguage.CHINESE -> "考虑使用箭头函数简化代码"
        AppLanguage.ENGLISH -> "Consider using arrow functions"
        AppLanguage.ARABIC -> "Consider using arrow functions"
    }

    val agentToolSplitLongLinesSuggestion: String get() = when (lang) {
        AppLanguage.CHINESE -> "部分行超过 120 字符，建议拆分以提高可读性"
        AppLanguage.ENGLISH -> "Split long lines over 120 characters for readability"
        AppLanguage.ARABIC -> "Split long lines over 120 characters for readability"
    }

    val agentToolFixVarToLet: String get() = when (lang) {
        AppLanguage.CHINESE -> "将 var 替换为 let"
        AppLanguage.ENGLISH -> "Replaced var with let"
        AppLanguage.ARABIC -> "Replaced var with let"
    }

    val agentToolFixEquality: String get() = when (lang) {
        AppLanguage.CHINESE -> "将 == 替换为 ==="
        AppLanguage.ENGLISH -> "Replaced == with ==="
        AppLanguage.ARABIC -> "Replaced == with ==="
    }

    fun agentToolSecurityDescription(type: String): String = when (lang) {
        AppLanguage.CHINESE -> when (type) {
            "eval" -> "使用 eval() 执行动态代码"
            "innerHTML" -> "直接设置 innerHTML 可能导致 XSS"
            "documentWrite" -> "document.write 可能被滥用"
            "dynamicFunction" -> "动态创建函数存在安全风险"
            "locationJump" -> "URL 跳转可能被利用"
            "storage" -> "存储敏感数据需谨慎"
            "fetch" -> "网络请求需注意安全"
            "postMessage" -> "跨窗口通信需验证来源"
            "templateInjection" -> "模板字符串注入风险"
            "base64" -> "Base64 不是加密"
            else -> "安全风险检测"
        }
        AppLanguage.ENGLISH -> when (type) {
            "eval" -> "Usage of eval()"
            "innerHTML" -> "Direct innerHTML assignment may lead to XSS"
            "documentWrite" -> "document.write may be abused"
            "dynamicFunction" -> "Dynamic function creation is risky"
            "locationJump" -> "URL redirects may be exploited"
            "storage" -> "Storing sensitive data requires caution"
            "fetch" -> "Network requests deserve careful handling"
            "postMessage" -> "Verify postMessage origins"
            "templateInjection" -> "Template string injection risk"
    ...
    fun agentToolSecurityRecommendation(type: String): String = when (lang) {
        AppLanguage.CHINESE -> when (type) {
            "eval" -> "避免使用 eval()，使用更安全的替代方案"
            "innerHTML" -> "使用 textContent 或 DOMPurify 清理 HTML"
            "documentWrite" -> "使用 DOM API 操作页面"
            "dynamicFunction" -> "避免动态创建函数"
            "locationJump" -> "验证跳转目标 URL"
            "storage" -> "不要在本地存储中保存敏感信息"
            "fetch" -> "确保请求目标可信，处理 CORS"
            "postMessage" -> "验证 message 事件的 origin"
            "templateInjection" -> "确保插入的变量已经过验证"
            "base64" -> "Base64 仅用于编码，不要用于安全目的"
            else -> "请修复安全风险"
        }
        AppLanguage.ENGLISH -> when (type) {
            "eval" -> "Avoid eval(); use a safer alternative"
            "innerHTML" -> "Use textContent or DOMPurify"
            "documentWrite" -> "Use DOM APIs instead"
            "dynamicFunction" -> "Avoid dynamically creating functions"
            "locationJump" -> "Validate redirect targets"
            "storage" -> "Avoid storing sensitive data locally"
            "fetch" -> "Ensure requests target trusted endpoints"
            "postMessage" -> "Validate the origin of postMessage"
            "templateInjection" -> "Validate interpolated values"
            "base64" -> "Base64 is encoding, not encryption"
            else -> "Please fix the security issue"
        }
        AppLanguage.ARABIC -> when (type) {
            "eval" -> "Avoid eval(); use a safer alternative"
            "innerHTML" -> "Use textContent or DOMPurify"
    ...
    val agentToolConfigMissingKey: String get() = when (lang) {
        AppLanguage.CHINESE -> "配置项缺少 key"
        AppLanguage.ENGLISH -> "Config item missing key"
        AppLanguage.ARABIC -> "Config item missing key"
    }

    val agentToolConfigMissingName: String get() = when (lang) {
        AppLanguage.CHINESE -> "配置项缺少显示名称"
        AppLanguage.ENGLISH -> "Config item missing display name"
        AppLanguage.ARABIC -> "Config item missing display name"
    }

    fun agentToolConfigMissingValue(name: String?): String = when (lang) {
        AppLanguage.CHINESE -> "必填配置项 '${name ?: ""}' 未设置值"
        AppLanguage.ENGLISH -> "Required config item '${name ?: ""}' is unset"
        AppLanguage.ARABIC -> "Required config item '${name ?: ""}' is unset"
    }

    val agentToolModuleNameMissing: String get() = when (lang) {
        AppLanguage.CHINESE -> "缺少模块名称"
        AppLanguage.ENGLISH -> "Missing module name"
        AppLanguage.ARABIC -> "Missing module name"
    }

    val agentToolModuleCreated: String get() = when (lang) {
        AppLanguage.CHINESE -> "模块创建成功"
        AppLanguage.ENGLISH -> "Module created successfully"
        AppLanguage.ARABIC -> "Module created successfully"
    }

    val agentToolModuleCreateFailed: String get() = when (lang) {
        AppLanguage.CHINESE -> "创建失败"
        AppLanguage.ENGLISH -> "Creation failed"
        AppLanguage.ARABIC -> "Creation failed"
    }

    fun agentToolUnknownTool(toolName: String): String = when (lang) {
        AppLanguage.CHINESE -> "未知工具: $toolName"
        AppLanguage.ENGLISH -> "Unknown tool: $toolName"
        AppLanguage.ARABIC -> "Unknown tool: $toolName"
    }

    val agentToolExecutionFailed: String get() = when (lang) {
        AppLanguage.CHINESE -> "执行失败"
        AppLanguage.ENGLISH -> "Execution failed"
        AppLanguage.ARABIC -> "Execution failed"
    }

    val agentToolToolExecutionFailed: String get() = when (lang) {
        AppLanguage.CHINESE -> "工具执行失败"
        AppLanguage.ENGLISH -> "Tool execution failed"
        AppLanguage.ARABIC -> "Tool execution failed"
    }

    val agentToolSyntaxCheckFailed: String get() = when (lang) {
        AppLanguage.CHINESE -> "语法检查执行失败"
        AppLanguage.ENGLISH -> "Syntax check failed"
        AppLanguage.ARABIC -> "Syntax check failed"
    }

    val agentToolFixFailed: String get() = when (lang) {
        AppLanguage.CHINESE -> "自动修复执行失败"
        AppLanguage.ENGLISH -> "Auto-fix failed"
        AppLanguage.ARABIC -> "Auto-fix failed"
    }

    fun agentToolMaxFixAttemptsExceeded(attempts: Int): String = when (lang) {
        AppLanguage.CHINESE -> "已达到最大自动修复次数 ($attempts 次)，仍有语法错误"
        AppLanguage.ENGLISH -> "Reached the maximum auto-fix attempts ($attempts) but syntax errors remain"
        AppLanguage.ARABIC -> "Reached the maximum auto-fix attempts ($attempts) but syntax errors remain"
    }

    val agentToolMissingCodeParam: String get() = when (lang) {
        AppLanguage.CHINESE -> "缺少 code 参数"
        AppLanguage.ENGLISH -> "Missing code parameter"
        AppLanguage.ARABIC -> "Missing code parameter"
    }

    fun agentToolUnsupportedLanguage(language: String): String = when (lang) {
        AppLanguage.CHINESE -> "不支持的语言: $language"
        AppLanguage.ENGLISH -> "Unsupported language: $language"
        AppLanguage.ARABIC -> "Unsupported language: $language"
    }
    ...
    val clonerPreparingIcon: String get() = when (lang) {
        AppLanguage.CHINESE -> "准备图标..."
        AppLanguage.ENGLISH -> "Preparing icon..."
        AppLanguage.ARABIC -> "准备图标..."
    }

    val clonerCreatingShortcut: String get() = when (lang) {
        AppLanguage.CHINESE -> "创建快捷方式..."
        AppLanguage.ENGLISH -> "Creating shortcut..."
        AppLanguage.ARABIC -> "创建快捷方式..."
    }

    val clonerUnableToGetLaunchIntent: String get() = when (lang) {
        AppLanguage.CHINESE -> "无法获取应用启动 Intent"
        AppLanguage.ENGLISH -> "Unable to get app launch intent"
        AppLanguage.ARABIC -> "无法获取应用启动 Intent"
    }

    val clonerLauncherNotSupported: String get() = when (lang) {
        AppLanguage.CHINESE -> "当前启动器不支持创建快捷方式"
        AppLanguage.ENGLISH -> "The current launcher doesn't support creating shortcuts"
        AppLanguage.ARABIC -> "当前启动器不支持创建快捷方式"
    }

    val clonerRequestingCreation: String get() = when (lang) {
        AppLanguage.CHINESE -> "请求创建..."
        AppLanguage.ENGLISH -> "Requesting creation..."
        AppLanguage.ARABIC -> "请求创建..."
    }

    val clonerDone: String get() = when (lang) {
        AppLanguage.CHINESE -> "完成"
        AppLanguage.ENGLISH -> "Done"
        AppLanguage.ARABIC -> "完成"
    }

    val clonerCreateShortcutFailedPermissions: String get() = when (lang) {
        AppLanguage.CHINESE -> "创建快捷方式失败，请检查权限设置"
        AppLanguage.ENGLISH -> "Failed to create shortcut. Please check permissions."
        AppLanguage.ARABIC -> "创建快捷方式失败，请检查权限设置"
    }

    val clonerCreateShortcutFailed: String get() = when (lang) {
        AppLanguage.CHINESE -> "创建快捷方式失败"
        AppLanguage.ENGLISH -> "Failed to create shortcut"
        AppLanguage.ARABIC -> "创建快捷方式失败"
    }
    ...
    val updateCheckFailed: String get() = when (lang) {
        ...
        AppLanguage.ARABIC -> "检查更新失败"
    }

    val networkRequestFailedWithCodeFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "网络请求失败: %d"
        AppLanguage.ENGLISH -> "Network request failed: %d"
        AppLanguage.ARABIC -> "网络请求失败: %d"
    }

    val httpErrorFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "HTTP 错误 %d"
        AppLanguage.ENGLISH -> "HTTP error %d"
        AppLanguage.ARABIC -> "خطأ HTTP %d"
    }
    ...
    val updateVersionNotFound: String get() = when (lang) {
        AppLanguage.CHINESE -> "未找到版本信息"
        AppLanguage.ENGLISH -> "Version info not found"
        AppLanguage.ARABIC -> "未找到版本信息"
    }

    // ==================== 通用网络/AI 错误提示 ====================
    val connectionFailedFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "连接失败: %d - %s"
        AppLanguage.ENGLISH -> "Connection failed: %d - %s"
        AppLanguage.ARABIC -> "连接失败: %d - %s"
    }

    val apiModelListEmpty: String get() = when (lang) {
        AppLanguage.CHINESE -> "API 返回的模型列表为空"
        AppLanguage.ENGLISH -> "API returned an empty model list"
        AppLanguage.ARABIC -> "API 返回的模型列表为空"
    }

    val fetchModelListFailedFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "获取模型列表失败: %d - %s"
        AppLanguage.ENGLISH -> "Failed to fetch model list: %d - %s"
        AppLanguage.ARABIC -> "获取模型列表失败: %d - %s"
    }

    val fetchModelListErrorFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "获取模型列表出错: %s"
        AppLanguage.ENGLISH -> "Error fetching model list: %s"
        AppLanguage.ARABIC -> "获取模型列表出错: %s"
    }

    val iconPromptTemplate: String get() = when (lang) {
        AppLanguage.CHINESE -> "生成一个精美的应用图标：\\n- 尺寸：1024x1024，正方形\\n- 风格：现代简洁专业\\n- 背景：纯色或简单渐变\\n- 图案：居中清晰，辨识度高\\n\\n用户需求：%s\\n\\n直接输出图标图片。"
        AppLanguage.ENGLISH -> "Generate a high-quality app icon:\\n- Size: 1024x1024, square\\n- Style: modern, clean, and professional\\n- Background: solid color or subtle gradient\\n- Icon: centered, clear, and highly recognizable\\n\\nUser request: %s\\n\\nOutput the icon image directly."
        AppLanguage.ARABIC -> "生成一个精美的应用图标：\\n- 尺寸：1024x1024，正方形\\n- 风格：现代简洁专业\\n- 背景：纯色或简单渐变\\n- 图案：居中清晰，辨识度高\\n\\n用户需求：%s\\n\\n直接输出图标图片。"
    }

    val generationFailedWithCodeFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "生成失败: %d"
        AppLanguage.ENGLISH -> "Generation failed: %d"
        AppLanguage.ARABIC -> "生成失败: %d"
    }

    val noImageDataFound: String get() = when (lang) {
        AppLanguage.CHINESE -> "未找到图像数据"
        AppLanguage.ENGLISH -> "No image data found"
        AppLanguage.ARABIC -> "未找到图像数据"
    }

    val apiBaseUrlNotConfiguredWithSettings: String get() = when (lang) {
        AppLanguage.CHINESE -> "未配置API地址，请在设置中填写Base URL"
        AppLanguage.ENGLISH -> "API base URL is not configured. Please set the Base URL in Settings."
        AppLanguage.ARABIC -> "未配置API地址，请在设置中填写Base URL"
    }

    val apiBaseUrlNotConfigured: String get() = when (lang) {
        AppLanguage.CHINESE -> "未配置API地址"
        AppLanguage.ENGLISH -> "API base URL is not configured"
        AppLanguage.ARABIC -> "未配置API地址"
    }

    val requestFailedWithBodyFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "请求失败: %d - %s"
        AppLanguage.ENGLISH -> "Request failed: %d - %s"
        AppLanguage.ARABIC -> "请求失败: %d - %s"
    }

    val unableToParseResponse: String get() = when (lang) {
        AppLanguage.CHINESE -> "无法解析响应"
        AppLanguage.ENGLISH -> "Unable to parse response"
        AppLanguage.ARABIC -> "无法解析响应"
    }

    val networkConnectionInterrupted: String get() = when (lang) {
        AppLanguage.CHINESE -> "网络连接中断，请检查网络后重试"
        AppLanguage.ENGLISH -> "Network connection interrupted. Please check your network and retry."
        AppLanguage.ARABIC -> "网络连接中断，请检查网络后重试"
    }

    val requestTimedOut: String get() = when (lang) {
        AppLanguage.CHINESE -> "请求超时，请检查网络连接"
        AppLanguage.ENGLISH -> "Request timed out. Please check your network connection."
        AppLanguage.ARABIC -> "请求超时，请检查网络连接"
    }

    val unableToConnectServer: String get() = when (lang) {
        AppLanguage.CHINESE -> "无法连接服务器，请检查网络或API地址"
        AppLanguage.ENGLISH -> "Unable to connect to server. Check your network or API address."
        AppLanguage.ARABIC -> "无法连接服务器，请检查网络或API地址"
    }

    val serverRefusedConnection: String get() = when (lang) {
        AppLanguage.CHINESE -> "服务器拒绝连接，请检查API地址是否正确"
        AppLanguage.ENGLISH -> "Server refused the connection. Check whether the API address is correct."
        AppLanguage.ARABIC -> "服务器拒绝连接，请检查API地址是否正确"
    }

    val networkConnectionFailed: String get() = when (lang) {
        AppLanguage.CHINESE -> "网络连接失败"
        AppLanguage.ENGLISH -> "Network connection failed"
        AppLanguage.ARABIC -> "网络连接失败"
    }

    val invalidRequestParametersFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "请求参数错误: %s"
        AppLanguage.ENGLISH -> "Invalid request parameters: %s"
        AppLanguage.ARABIC -> "请求参数错误: %s"
    }

    val apiKeyInvalidOrExpired: String get() = when (lang) {
        AppLanguage.CHINESE -> "API Key 无效或已过期，请检查设置"
        AppLanguage.ENGLISH -> "API key is invalid or expired. Please check settings."
        AppLanguage.ARABIC -> "API Key 无效或已过期，请检查设置"
    }

    val apiAccessDenied: String get() = when (lang) {
        AppLanguage.CHINESE -> "API 访问被拒绝，请检查权限或配额"
        AppLanguage.ENGLISH -> "API access denied. Please check permissions or quota."
        AppLanguage.ARABIC -> "API 访问被拒绝，请检查权限或配额"
    }

    val modelNotFoundOrEndpointError: String get() = when (lang) {
        AppLanguage.CHINESE -> "模型不存在或 API 端点错误，请检查模型名称"
        AppLanguage.ENGLISH -> "Model not found or API endpoint error. Please check the model name."
        AppLanguage.ARABIC -> "模型不存在或 API 端点错误，请检查模型名称"
    }

    val tooManyRequests: String get() = when (lang) {
        AppLanguage.CHINESE -> "请求过于频繁，请稍后重试"
        AppLanguage.ENGLISH -> "Too many requests. Please try again later."
        AppLanguage.ARABIC -> "请求过于频繁，请稍后重试"
    }

    val serverErrorTryLater: String get() = when (lang) {
        AppLanguage.CHINESE -> "服务器错误，请稍后重试"
        AppLanguage.ENGLISH -> "Server error. Please try again later."
        AppLanguage.ARABIC -> "服务器错误，请稍后重试"
    }

    val emptyResponseBody: String get() = when (lang) {
        AppLanguage.CHINESE -> "响应体为空"
        AppLanguage.ENGLISH -> "Empty response body"
        AppLanguage.ARABIC -> "响应体为空"
    }

    val apiReturnedError: String get() = when (lang) {
        AppLanguage.CHINESE -> "API返回错误"
        AppLanguage.ENGLISH -> "API returned an error"
        AppLanguage.ARABIC -> "API返回错误"
    }

    val noDataReceivedStreaming: String get() = when (lang) {
        AppLanguage.CHINESE -> "未收到任何数据，API可能不支持流式输出"
        AppLanguage.ENGLISH -> "No data received; the API may not support streaming."
        AppLanguage.ARABIC -> "未收到任何数据，API可能不支持流式输出"
    }

    val unexpectedApiResponseFormatPreviewFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "API返回数据格式异常，请查看日志或尝试其他模型。数据预览: %s..."
        AppLanguage.ENGLISH -> "Unexpected API response format. Check logs or try another model. Preview: %s..."
        AppLanguage.ARABIC -> "API返回数据格式异常，请查看日志或尝试其他模型。数据预览: %s..."
    }

    val failedToReadResponse: String get() = when (lang) {
        AppLanguage.CHINESE -> "读取响应失败"
        AppLanguage.ENGLISH -> "Failed to read response"
        AppLanguage.ARABIC -> "读取响应失败"
    }

    val imageGenerationFailedWithBodyFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "图像生成失败: %d - %s"
        AppLanguage.ENGLISH -> "Image generation failed: %d - %s"
        AppLanguage.ARABIC -> "图像生成失败: %d - %s"
    }

    val failedToDownloadImage: String get() = when (lang) {
        AppLanguage.CHINESE -> "下载图像失败"
        AppLanguage.ENGLISH -> "Failed to download image"
        AppLanguage.ARABIC -> "下载图像失败"
    }

    val failedToDownloadImageWithCodeFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "下载图像失败: %d"
        AppLanguage.ENGLISH -> "Failed to download image: %d"
        AppLanguage.ARABIC -> "下载图像失败: %d"
    }
    ...
    val saveComplete: String get() = when (lang) {
        AppLanguage.CHINESE -> "保存完成"
        AppLanguage.ENGLISH -> "Save complete"
        AppLanguage.ARABIC -> "اكتمل الحفظ"
    }

    val shareTypeFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "分享 %s"
        AppLanguage.ENGLISH -> "Share %s"
        AppLanguage.ARABIC -> "مشاركة %s"
    }

    val savedToGalleryFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "%s已保存到相册"
        AppLanguage.ENGLISH -> "%s saved to gallery"
        AppLanguage.ARABIC -> "تم حفظ %s في المعرض"
    }

    val unsupportedMediaType: String get() = when (lang) {
        AppLanguage.CHINESE -> "不支持的媒体类型"
        AppLanguage.ENGLISH -> "Unsupported media type"
        AppLanguage.ARABIC -> "نوع وسائط غير مدعوم"
    }
    ...
    val translateButton: String get() = when (lang) {
        AppLanguage.CHINESE -> "翻译"
        AppLanguage.ENGLISH -> "Translate"
        AppLanguage.ARABIC -> "翻译"
    }

    val translating: String get() = when (lang) {
        AppLanguage.CHINESE -> "翻译中..."
        AppLanguage.ENGLISH -> "Translating..."
        AppLanguage.ARABIC -> "翻译中..."
    }

    val translated: String get() = when (lang) {
        AppLanguage.CHINESE -> "已翻译"
        AppLanguage.ENGLISH -> "Translated"
        AppLanguage.ARABIC -> "已翻译"
    }
    ...
    val builtinBilibiliExtractorDesc: String get() = when (lang) {
        ...
        AppLanguage.ENGLISH -> "Extract the highest quality video and audio streams from Bilibili"
        AppLanguage.ARABIC -> "استخراج أعلى جودة لفيديو وصوت بيليبيلي"
    }
    ...
    fun languageSelectorWelcome(language: AppLanguage): String = when (language) {
        AppLanguage.CHINESE -> "欢迎"
        AppLanguage.ENGLISH -> "Welcome"
        AppLanguage.ARABIC -> "欢迎"
    }

    fun languageSelectorSelectLanguage(language: AppLanguage): String = when (language) {
        AppLanguage.CHINESE -> "选择语言"
        AppLanguage.ENGLISH -> "Select Language"
        AppLanguage.ARABIC -> "选择语言"
    }

    fun languageSelectorConfirm(language: AppLanguage): String = when (language) {
        AppLanguage.CHINESE -> "确认"
        AppLanguage.ENGLISH -> "Confirm"
        AppLanguage.ARABIC -> "确认"
    }

    val languageSelectorWelcomeMulti: String get() = when (lang) {
        AppLanguage.CHINESE -> "Welcome / 欢迎 / مرحبا"
        AppLanguage.ENGLISH -> "Welcome / 欢迎 / مرحبا"
        AppLanguage.ARABIC -> "Welcome / 欢迎 / مرحبا"
    }

    val languageSelectorSelectLanguageMulti: String get() = when (lang) {
        AppLanguage.CHINESE -> "Select Language / 选择语言 / اختر اللغة"
        AppLanguage.ENGLISH -> "Select Language / 选择语言 / اختر اللغة"
        AppLanguage.ARABIC -> "Select Language / 选择语言 / اختر اللغة"
    }

    val languageSelectorConfirmMulti: String get() = when (lang) {
        AppLanguage.CHINESE -> "Confirm / 确认 / تأكيد"
        AppLanguage.ENGLISH -> "Confirm / 确认 / تأكيد"
        AppLanguage.ARABIC -> "Confirm / 确认 / تأكيد"
    }
    ...
    val forcedRunChannelName: String get() = when (lang) {
        AppLanguage.CHINESE -> "强制运行守护"
        AppLanguage.ENGLISH -> "Forced Run Guard"
        AppLanguage.ARABIC -> "حارس التشغيل الإجباري"
    }

    val forcedRunChannelDescription: String get() = when (lang) {
        AppLanguage.CHINESE -> "保持应用在前台运行"
        AppLanguage.ENGLISH -> "Keep the app running in the foreground"
        AppLanguage.ARABIC -> "إبقاء التطبيق يعمل في المقدمة"
    }
    ...
    val forcedRunReturnToApp: String get() = when (lang) {
    ...
    val forcedRunPermissionSetup: String get() = when (lang) {
        AppLanguage.CHINESE -> "强制运行权限设置"
        AppLanguage.ENGLISH -> "Forced run permission setup"
        AppLanguage.ARABIC -> "强制运行权限设置"
    }

    val forcedRunPermissionIntro: String get() = when (lang) {
    ...
    val accessibilityServiceDesc: String get() = when (lang) {
        ...
        AppLanguage.ARABIC -> "监控窗口变化，防止用户切换应用"
    }

    val usageAccess: String get() = when (lang) {
        AppLanguage.CHINESE -> "使用情况访问"
        AppLanguage.ENGLISH -> "Usage access"
        AppLanguage.ARABIC -> "使用情况访问"
    }

    val usageAccessDesc: String get() = when (lang) {
        AppLanguage.CHINESE -> "检测当前前台应用，提供双重防护"
        AppLanguage.ENGLISH -> "Detect the foreground app for extra protection"
        AppLanguage.ARABIC -> "检测当前前台应用，提供双重防护"
    }

    val refreshPermissionStatus: String get() = when (lang) {
        AppLanguage.CHINESE -> "刷新权限状态"
        AppLanguage.ENGLISH -> "Refresh permission status"
        AppLanguage.ARABIC -> "刷新权限状态"
    }

    val grant: String get() = when (lang) {
        AppLanguage.CHINESE -> "授权"
        AppLanguage.ENGLISH -> "Grant"
        AppLanguage.ARABIC -> "授权"
    }

    val granted: String get() = when (lang) {
        AppLanguage.CHINESE -> "已授权"
        AppLanguage.ENGLISH -> "Granted"
        AppLanguage.ARABIC -> "已授权"
    }

    val protectionBasic: String get() = when (lang) {
        AppLanguage.CHINESE -> "基础防护"
        AppLanguage.ENGLISH -> "Basic protection"
        AppLanguage.ARABIC -> "基础防护"
    }

    val protectionBasicDesc: String get() = when (lang) {
        AppLanguage.CHINESE -> "仅拦截返回键，防护效果有限"
        AppLanguage.ENGLISH -> "Only blocks the back key; limited protection"
        AppLanguage.ARABIC -> "仅拦截返回键，防护效果有限"
    }

    val protectionStandard: String get() = when (lang) {
        AppLanguage.CHINESE -> "标准防护"
        AppLanguage.ENGLISH -> "Standard protection"
        AppLanguage.ARABIC -> "标准防护"
    }

    val protectionStandardDesc: String get() = when (lang) {
        AppLanguage.CHINESE -> "通过辅助功能监控窗口，有效阻止应用切换"
        AppLanguage.ENGLISH -> "Monitors windows via accessibility to prevent app switching"
        AppLanguage.ARABIC -> "通过辅助功能监控窗口，有效阻止应用切换"
    }

    val protectionMaximum: String get() = when (lang) {
        AppLanguage.CHINESE -> "最强防护"
        AppLanguage.ENGLISH -> "Maximum protection"
        AppLanguage.ARABIC -> "最强防护"
    }

    val protectionMaximumDesc: String get() = when (lang) {
        AppLanguage.CHINESE -> "辅助功能 + 后台守护服务，双重防护确保万无一失"
        AppLanguage.ENGLISH -> "Accessibility + background guard service for maximum protection"
        AppLanguage.ARABIC -> "辅助功能 + 后台守护服务，双重防护确保万无一失"
    }

    val permissionsReady: String get() = when (lang) {
        AppLanguage.CHINESE -> "权限已就绪"
        AppLanguage.ENGLISH -> "Permissions ready"
        AppLanguage.ARABIC -> "权限已就绪"
    }

    val permissionsRequired: String get() = when (lang) {
        AppLanguage.CHINESE -> "需要授权"
        AppLanguage.ENGLISH -> "Permissions required"
        AppLanguage.ARABIC -> "需要授权"
    }

    val skipReducedProtection: String get() = when (lang) {
        AppLanguage.CHINESE -> "跳过（降级防护）"
        AppLanguage.ENGLISH -> "Skip (reduced protection)"
        AppLanguage.ARABIC -> "跳过（降级防护）"
    }

    val basicProtectionNoExtraPermissions: String get() = when (lang) {
        AppLanguage.CHINESE -> "基础防护无需额外权限"
        AppLanguage.ENGLISH -> "Basic protection requires no extra permissions"
        AppLanguage.ARABIC -> "基础防护无需额外权限"
    }

    val accessibilityServiceEnabled: String get() = when (lang) {
        AppLanguage.CHINESE -> "辅助功能已启用"
        AppLanguage.ENGLISH -> "Accessibility service enabled"
        AppLanguage.ARABIC -> "辅助功能已启用"
    }

    val accessibilityServiceRequired: String get() = when (lang) {
        AppLanguage.CHINESE -> "需要启用辅助功能服务"
        AppLanguage.ENGLISH -> "Accessibility service required"
        AppLanguage.ARABIC -> "需要启用辅助功能服务"
    }

    val usageAccessPermissionRequired: String get() = when (lang) {
        AppLanguage.CHINESE -> "需要授权使用情况访问权限"
        AppLanguage.ENGLISH -> "Usage access permission required"
        AppLanguage.ARABIC -> "需要授权使用情况访问权限"
    }

    val allPermissionsGranted: String get() = when (lang) {
        AppLanguage.CHINESE -> "所有权限已授权"
        AppLanguage.ENGLISH -> "All permissions granted"
        AppLanguage.ARABIC -> "所有权限已授权"
    }

    val forcedRunAccessBlockedWithRemainingFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "当前不在允许进入时间，请稍后再试（剩余 %s）。"
        AppLanguage.ENGLISH -> "App not accessible at this time, please try later (remaining %s)."
        AppLanguage.ARABIC -> "当前不在允许进入时间，请稍后再试（剩余 %s）。"
    }

    val forcedRunAccessBlocked: String get() = when (lang) {
        AppLanguage.CHINESE -> "当前不在允许进入时间，请稍后再试。"
        AppLanguage.ENGLISH -> "App not accessible at this time, please try later."
        AppLanguage.ARABIC -> "当前不在允许进入时间，请稍后再试。"
    }

    val activationPermanent: String get() = when (lang) {
        AppLanguage.CHINESE -> "永久激活码"
        AppLanguage.ENGLISH -> "Permanent activation code"
        AppLanguage.ARABIC -> "永久激活码"
    }

    val activationPermanentDesc: String get() = when (lang) {
        AppLanguage.CHINESE -> "一次激活，永久使用"
        AppLanguage.ENGLISH -> "Activate once and use forever"
        AppLanguage.ARABIC -> "一次激活，永久使用"
    }

    val activationTimeLimited: String get() = when (lang) {
        AppLanguage.CHINESE -> "限时激活码"
        AppLanguage.ENGLISH -> "Time-limited activation code"
        AppLanguage.ARABIC -> "限时激活码"
    }

    val activationTimeLimitedDesc: String get() = when (lang) {
        AppLanguage.CHINESE -> "激活后仅在设定时间范围内可用"
        AppLanguage.ENGLISH -> "Available only within the configured time window after activation"
        AppLanguage.ARABIC -> "激活后仅在设定时间范围内可用"
    }

    val activationUsageLimited: String get() = when (lang) {
        AppLanguage.CHINESE -> "次数限制激活码"
        AppLanguage.ENGLISH -> "Usage-limited activation code"
        AppLanguage.ARABIC -> "次数限制激活码"
    }

    val activationUsageLimitedDesc: String get() = when (lang) {
        AppLanguage.CHINESE -> "激活次数用完即失效"
        AppLanguage.ENGLISH -> "Expires after the allowed number of activations"
        AppLanguage.ARABIC -> "激活次数用完即失效"
    }

    val activationDeviceBound: String get() = when (lang) {
        AppLanguage.CHINESE -> "设备绑定激活码"
        AppLanguage.ENGLISH -> "Device-bound activation code"
        AppLanguage.ARABIC -> "设备绑定激活码"
    }

    val activationDeviceBoundDesc: String get() = when (lang) {
        AppLanguage.CHINESE -> "只在绑定设备上有效"
        AppLanguage.ENGLISH -> "Valid only on the bound device"
        AppLanguage.ARABIC -> "只在绑定设备上有效"
    }

    val activationCombined: String get() = when (lang) {
        AppLanguage.CHINESE -> "组合型激活码"
        AppLanguage.ENGLISH -> "Combined activation code"
        AppLanguage.ARABIC -> "组合型激活码"
    }

    val activationCombinedDesc: String get() = when (lang) {
        AppLanguage.CHINESE -> "同时受时长、次数、设备等控制"
        AppLanguage.ENGLISH -> "Controlled by time, usage count, device, etc."
        AppLanguage.ARABIC -> "同时受时长、次数、设备等控制"
    }
    ...
    // ==================== Additional user strings ====================
    val invalidTimeLimitConfig: String get() = when (lang) {
        AppLanguage.CHINESE -> "无效的限时激活配置"
        AppLanguage.ENGLISH -> "Invalid time limit configuration"
        AppLanguage.ARABIC -> "无效的限时激活配置"
    }

    val invalidUsageLimitConfig: String get() = when (lang) {
        AppLanguage.CHINESE -> "无效的次数限制配置"
        AppLanguage.ENGLISH -> "Invalid usage limit configuration"
        AppLanguage.ARABIC -> "无效的次数限制配置"
    }

    val batchGeneratedNote: String get() = when (lang) {
        AppLanguage.CHINESE -> "批量生成可能导致多条激活记录，确认继续？"
        AppLanguage.ENGLISH -> "Batch generation may create multiple activations, proceed?"
        AppLanguage.ARABIC -> "批量生成可能导致多条激活记录，确认继续？"
    }

    val interstitialAdNotConfigured: String get() = when (lang) {
        AppLanguage.CHINESE -> "插页广告未配置"
        AppLanguage.ENGLISH -> "Interstitial ad not configured"
        AppLanguage.ARABIC -> "插页广告未配置"
    }

    val shortcutPermissionTitle: String get() = when (lang) {
        AppLanguage.CHINESE -> "创建快捷方式权限"
        AppLanguage.ENGLISH -> "Shortcut permission"
        AppLanguage.ARABIC -> "创建快捷方式权限"
    }

    val openSettings: String get() = when (lang) {
        AppLanguage.CHINESE -> "打开设置"
        AppLanguage.ENGLISH -> "Open settings"
        AppLanguage.ARABIC -> "打开设置"
    }

    val notNow: String get() = when (lang) {
        AppLanguage.CHINESE -> "暂不"
        AppLanguage.ENGLISH -> "Not now"
        AppLanguage.ARABIC -> "暂不"
    }

    val shortcutPermissionMessageXiaomi: String get() = when (lang) {
        AppLanguage.CHINESE -> "小米：请开启「自启动 + 后台管理」"
        AppLanguage.ENGLISH -> "Xiaomi: enable Autostart & Background management"
        AppLanguage.ARABIC -> "小米：请开启「自启动 + 后台管理」"
    }

    val shortcutPermissionMessageHuawei: String get() = when (lang) {
        AppLanguage.CHINESE -> "华为：请允许「自启动 + 后台弹窗」"
        AppLanguage.ENGLISH -> "Huawei: allow Autostart & Background popup"
        AppLanguage.ARABIC -> "华为：请允许「自启动 + 后台弹窗」"
    }

    val shortcutPermissionMessageOppo: String get() = when (lang) {
        AppLanguage.CHINESE -> "OPPO：请开启「后台弹窗 + 电量优化」"
        AppLanguage.ENGLISH -> "Oppo: enable background popup & battery optimization exception"
        AppLanguage.ARABIC -> "OPPO：请开启「后台弹窗 + 电量优化」"
    }

    val shortcutPermissionMessageVivo: String get() = when (lang) {
        AppLanguage.CHINESE -> "vivo：请设置「后台管理 + 应用锁」"
        AppLanguage.ENGLISH -> "Vivo: configure Background management & App lock"
        AppLanguage.ARABIC -> "vivo：请设置「后台管理 + 应用锁」"
    }

    val shortcutPermissionMessageMeizu: String get() = when (lang) {
        AppLanguage.CHINESE -> "魅族：请解除后台限制"
        AppLanguage.ENGLISH -> "Meizu: lift the background restriction"
        AppLanguage.ARABIC -> "魅族：请解除后台限制"
    }

    val shortcutPermissionMessageSamsung: String get() = when (lang) {
        AppLanguage.CHINESE -> "三星：请设置「后台应用限制」为无限制"
        AppLanguage.ENGLISH -> "Samsung: set Background app limit to unrestricted"
        AppLanguage.ARABIC -> "三星：请设置「后台应用限制」为无限制"
    }

    val shortcutPermissionMessageGeneric: String get() = when (lang) {
        AppLanguage.CHINESE -> "请在系统设置中授权该应用自启动和后台运行"
        AppLanguage.ENGLISH -> "Grant Autostart & Background execution in system settings"
        AppLanguage.ARABIC -> "请在系统设置中授权该应用自启动和后台运行"
    }

    val coverLabel: String get() = when (lang) {
        AppLanguage.CHINESE -> "封面"
        AppLanguage.ENGLISH -> "Cover"
        AppLanguage.ARABIC -> "封面"
    }

    val untitled: String get() = when (lang) {
        AppLanguage.CHINESE -> "未命名"
        AppLanguage.ENGLISH -> "Untitled"
        AppLanguage.ARABIC -> "未命名"
    }

    val animationPositionFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "动画位置：%s"
        AppLanguage.ENGLISH -> "Animation position: %s"
        AppLanguage.ARABIC -> "动画位置：%s"
    }

    val exportSuccessMessage: String get() = when (lang) {
        AppLanguage.CHINESE -> "导出成功"
        AppLanguage.ENGLISH -> "Export successful"
        AppLanguage.ARABIC -> "导出成功"
    }

    val exportFailedMessage: String get() = when (lang) {
        AppLanguage.CHINESE -> "导出失败"
        AppLanguage.ENGLISH -> "Export failed"
        AppLanguage.ARABIC -> "导出失败"
    }

    val exportTemplateFailedMessage: String get() = when (lang) {
        AppLanguage.CHINESE -> "导出模板失败"
        AppLanguage.ENGLISH -> "Template export failed"
        AppLanguage.ARABIC -> "导出模板失败"
    }

    val importSuccessMessage: String get() = when (lang) {
        AppLanguage.CHINESE -> "导入成功"
        AppLanguage.ENGLISH -> "Import successful"
        AppLanguage.ARABIC -> "导入成功"
    }

    val importFailedMessage: String get() = when (lang) {
        AppLanguage.CHINESE -> "导入失败"
        AppLanguage.ENGLISH -> "Import failed"
        AppLanguage.ARABIC -> "导入失败"
    }

    val tapToExit: String get() = when (lang) {
        AppLanguage.CHINESE -> "点击退出"
        AppLanguage.ENGLISH -> "Tap to exit"
        AppLanguage.ARABIC -> "点击退出"
    }

    val enterExitPassword: String get() = when (lang) {
        AppLanguage.CHINESE -> "输入退出密码"
        AppLanguage.ENGLISH -> "Enter exit password"
        AppLanguage.ARABIC -> "输入退出密码"
    }

    val exitPasswordPrompt: String get() = when (lang) {
        AppLanguage.CHINESE -> "设置紧急退出密码"
        AppLanguage.ENGLISH -> "Set an emergency password"
        AppLanguage.ARABIC -> "设置紧急退出密码"
    }

    val passwordLabel: String get() = when (lang) {
        AppLanguage.CHINESE -> "密码"
        AppLanguage.ENGLISH -> "Password"
        AppLanguage.ARABIC -> "密码"
    }

    val passwordPlaceholder: String get() = when (lang) {
        AppLanguage.CHINESE -> "请输入密码"
        AppLanguage.ENGLISH -> "Enter password"
        AppLanguage.ARABIC -> "请输入密码"
    }

    val passwordAttemptsRemaining: String get() = when (lang) {
        AppLanguage.CHINESE -> "剩余尝试次数：%d"
        AppLanguage.ENGLISH -> "Remaining attempts: %d"
        AppLanguage.ARABIC -> "剩余尝试次数：%d"
    }

    val tooManyPasswordAttempts: String get() = when (lang) {
        AppLanguage.CHINESE -> "尝试次数过多，请稍后再试"
        AppLanguage.ENGLISH -> "Too many attempts. Please try later."
        AppLanguage.ARABIC -> "尝试次数过多，请稍后再试"
    }

    val confirmExit: String get() = when (lang) {
        AppLanguage.CHINESE -> "确认退出"
        AppLanguage.ENGLISH -> "Confirm exit"
        AppLanguage.ARABIC -> "确认退出"
    }

    val imagePreview: String get() = when (lang) {
        AppLanguage.CHINESE -> "图片预览"
        AppLanguage.ENGLISH -> "Image preview"
        AppLanguage.ARABIC -> "图片预览"
    }

    val saveImage: String get() = when (lang) {
        AppLanguage.CHINESE -> "保存图片"
        AppLanguage.ENGLISH -> "Save image"
        AppLanguage.ARABIC -> "保存图片"
    }

    val copyImageLink: String get() = when (lang) {
        AppLanguage.CHINESE -> "复制图片链接"
        AppLanguage.ENGLISH -> "Copy image link"
        AppLanguage.ARABIC -> "复制图片链接"
    }

    val videoLabel: String get() = when (lang) {
        AppLanguage.CHINESE -> "视频"
        AppLanguage.ENGLISH -> "Video"
        AppLanguage.ARABIC -> "视频"
    }

    val downloadVideo: String get() = when (lang) {
        AppLanguage.CHINESE -> "下载视频"
        AppLanguage.ENGLISH -> "Download video"
        AppLanguage.ARABIC -> "下载视频"
    }

    val copyVideoLink: String get() = when (lang) {
        AppLanguage.CHINESE -> "复制视频链接"
        AppLanguage.ENGLISH -> "Copy video link"
        AppLanguage.ARABIC -> "复制视频链接"
    }

    val copyLink: String get() = when (lang) {
        AppLanguage.CHINESE -> "复制链接"
        AppLanguage.ENGLISH -> "Copy link"
        AppLanguage.ARABIC -> "复制链接"
    }

    val openInBrowser: String get() = when (lang) {
        AppLanguage.CHINESE -> "在浏览器中打开"
        AppLanguage.ENGLISH -> "Open in browser"
        AppLanguage.ARABIC -> "在浏览器中打开"
    }

    val imageLabel: String get() = when (lang) {
        AppLanguage.CHINESE -> "图片"
        AppLanguage.ENGLISH -> "Image"
        AppLanguage.ARABIC -> "图片"
    }

    val linkLabel: String get() = when (lang) {
        AppLanguage.CHINESE -> "链接"
        AppLanguage.ENGLISH -> "Link"
        AppLanguage.ARABIC -> "链接"
    }

    val lrcEditorTitle: String get() = when (lang) {
        AppLanguage.CHINESE -> "歌词编辑"
        AppLanguage.ENGLISH -> "LRC editor"
        AppLanguage.ARABIC -> "歌词编辑"
    }

    val lrcLineCount: String get() = when (lang) {
        AppLanguage.CHINESE -> "%d 行歌词"
        AppLanguage.ENGLISH -> "%d lines"
        AppLanguage.ARABIC -> "%d 行歌词"
    }

    val addLine: String get() = when (lang) {
        AppLanguage.CHINESE -> "添加行"
        AppLanguage.ENGLISH -> "Add line"
        AppLanguage.ARABIC -> "添加行"
    }

    val rewind5s: String get() = when (lang) {
        AppLanguage.CHINESE -> "后退5秒"
        AppLanguage.ENGLISH -> "Rewind 5s"
        AppLanguage.ARABIC -> "后退5秒"
    }

    val forward5s: String get() = when (lang) {
        AppLanguage.CHINESE -> "前进5秒"
        AppLanguage.ENGLISH -> "Forward 5s"
        AppLanguage.ARABIC -> "前进5秒"
    }

    val emptyLine: String get() = when (lang) {
        AppLanguage.CHINESE -> "空行"
        AppLanguage.ENGLISH -> "Empty line"
        AppLanguage.ARABIC -> "空行"
    }

    val timeAdjustLabel: String get() = when (lang) {
        AppLanguage.CHINESE -> "时间微调"
        AppLanguage.ENGLISH -> "Time adjust"
        AppLanguage.ARABIC -> "时间微调"
    }

    val setToCurrent: String get() = when (lang) {
        AppLanguage.CHINESE -> "设置为当前"
        AppLanguage.ENGLISH -> "Set to current"
        AppLanguage.ARABIC -> "设置为当前"
    }

    val secondsShortFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "%ds"
        AppLanguage.ENGLISH -> "%ds"
        AppLanguage.ARABIC -> "%ds"
    }

    val hotKeywordJayChou: String get() = when (lang) {
        AppLanguage.CHINESE -> "周杰伦"
        AppLanguage.ENGLISH -> "Jay Chou"
        AppLanguage.ARABIC -> "周杰伦"
    }

    val hotKeywordJjLin: String get() = when (lang) {
        AppLanguage.CHINESE -> "林俊杰"
        AppLanguage.ENGLISH -> "JJ Lin"
        AppLanguage.ARABIC -> "林俊杰"
    }

    val hotKeywordGem: String get() = when (lang) {
        AppLanguage.CHINESE -> "邓紫棋"
        AppLanguage.ENGLISH -> "G.E.M."
        AppLanguage.ARABIC -> "邓紫棋"
    }

    val hotKeywordJokerXue: String get() = when (lang) {
        AppLanguage.CHINESE -> "薛之谦"
        AppLanguage.ENGLISH -> "Joker Xue"
        AppLanguage.ARABIC -> "薛之谦"
    }

    val hotKeywordInstrumental: String get() = when (lang) {
        AppLanguage.CHINESE -> "纯音乐"
        AppLanguage.ENGLISH -> "Instrumental"
        AppLanguage.ARABIC -> "纯音乐"
    }

    val hotKeywordLightMusic: String get() = when (lang) {
        AppLanguage.CHINESE -> "轻音乐"
        AppLanguage.ENGLISH -> "Light music"
        AppLanguage.ARABIC -> "轻音乐"
    }

    val hotKeywordPianoMusic: String get() = when (lang) {
        AppLanguage.CHINESE -> "钢琴曲"
        AppLanguage.ENGLISH -> "Piano music"
        AppLanguage.ARABIC -> "钢琴曲"
    }

    val hotKeywordChineseStyle: String get() = when (lang) {
        AppLanguage.CHINESE -> "中国风"
        AppLanguage.ENGLISH -> "Chinese style"
        AppLanguage.ARABIC -> "中国风"
    }

    val hotKeywordAnime: String get() = when (lang) {
        AppLanguage.CHINESE -> "动漫"
        AppLanguage.ENGLISH -> "Anime"
        AppLanguage.ARABIC -> "动漫"
    }
    // ==================== Missing strings (fallbacks) ====================

    val aiModulePromptRequired: String get() = when (lang) {
        AppLanguage.CHINESE -> "Prompt required"
        AppLanguage.ENGLISH -> "Prompt required"
        AppLanguage.ARABIC -> "Prompt required"
    }

    val analyzingDots: String get() = when (lang) {
        AppLanguage.CHINESE -> "Analyzing..."
        AppLanguage.ENGLISH -> "Analyzing..."
        AppLanguage.ARABIC -> "Analyzing..."
    }

    val apkBuildSuccessInstalling: String get() = when (lang) {
        AppLanguage.CHINESE -> "Build succeeded, installing..."
        AppLanguage.ENGLISH -> "Build succeeded, installing..."
        AppLanguage.ARABIC -> "Build succeeded, installing..."
    }

    val appDeleted: String get() = when (lang) {
        AppLanguage.CHINESE -> "App deleted"
        AppLanguage.ENGLISH -> "App deleted"
        AppLanguage.ARABIC -> "App deleted"
    }

    val appNameRequired: String get() = when (lang) {
        AppLanguage.CHINESE -> "App name required"
        AppLanguage.ENGLISH -> "App name required"
        AppLanguage.ARABIC -> "App name required"
    }

    val appSavedSuccess: String get() = when (lang) {
        AppLanguage.CHINESE -> "App saved"
        AppLanguage.ENGLISH -> "App saved"
        AppLanguage.ARABIC -> "App saved"
    }

    val bgmTagAnime: String get() = when (lang) {
        AppLanguage.CHINESE -> "Anime"
        AppLanguage.ENGLISH -> "Anime"
        AppLanguage.ARABIC -> "Anime"
    }

    val bgmTagChineseStyle: String get() = when (lang) {
        AppLanguage.CHINESE -> "Chinese style"
        AppLanguage.ENGLISH -> "Chinese style"
        AppLanguage.ARABIC -> "Chinese style"
    }

    val bgmTagClassical: String get() = when (lang) {
        AppLanguage.CHINESE -> "Classical"
        AppLanguage.ENGLISH -> "Classical"
        AppLanguage.ARABIC -> "Classical"
    }

    val bgmTagElectronic: String get() = when (lang) {
        AppLanguage.CHINESE -> "Electronic"
        AppLanguage.ENGLISH -> "Electronic"
        AppLanguage.ARABIC -> "Electronic"
    }

    val bgmTagExciting: String get() = when (lang) {
        AppLanguage.CHINESE -> "Exciting"
        AppLanguage.ENGLISH -> "Exciting"
        AppLanguage.ARABIC -> "Exciting"
    }

    val bgmTagFolk: String get() = when (lang) {
        AppLanguage.CHINESE -> "Folk"
        AppLanguage.ENGLISH -> "Folk"
        AppLanguage.ARABIC -> "Folk"
    }

    val bgmTagGame: String get() = when (lang) {
        AppLanguage.CHINESE -> "Game"
        AppLanguage.ENGLISH -> "Game"
        AppLanguage.ARABIC -> "Game"
    }

    val bgmTagHealing: String get() = when (lang) {
        AppLanguage.CHINESE -> "Healing"
        AppLanguage.ENGLISH -> "Healing"
        AppLanguage.ARABIC -> "Healing"
    }

    val bgmTagJazz: String get() = when (lang) {
        AppLanguage.CHINESE -> "Jazz"
        AppLanguage.ENGLISH -> "Jazz"
        AppLanguage.ARABIC -> "Jazz"
    }

    val bgmTagMovie: String get() = when (lang) {
        AppLanguage.CHINESE -> "Movie"
        AppLanguage.ENGLISH -> "Movie"
        AppLanguage.ARABIC -> "Movie"
    }

    val bgmTagOther: String get() = when (lang) {
        AppLanguage.CHINESE -> "Other"
        AppLanguage.ENGLISH -> "Other"
        AppLanguage.ARABIC -> "Other"
    }

    val bgmTagPop: String get() = when (lang) {
        AppLanguage.CHINESE -> "Pop"
        AppLanguage.ENGLISH -> "Pop"
        AppLanguage.ARABIC -> "Pop"
    }

    val bgmTagPureMusic: String get() = when (lang) {
        AppLanguage.CHINESE -> "Pure music"
        AppLanguage.ENGLISH -> "Pure music"
        AppLanguage.ARABIC -> "Pure music"
    }

    val bgmTagRelaxing: String get() = when (lang) {
        AppLanguage.CHINESE -> "Relaxing"
        AppLanguage.ENGLISH -> "Relaxing"
        AppLanguage.ARABIC -> "Relaxing"
    }

    val bgmTagRock: String get() = when (lang) {
        AppLanguage.CHINESE -> "Rock"
        AppLanguage.ENGLISH -> "Rock"
        AppLanguage.ARABIC -> "Rock"
    }

    val bgmTagRomantic: String get() = when (lang) {
        AppLanguage.CHINESE -> "Romantic"
        AppLanguage.ENGLISH -> "Romantic"
        AppLanguage.ARABIC -> "Romantic"
    }

    val bgmTagSad: String get() = when (lang) {
        AppLanguage.CHINESE -> "Sad"
        AppLanguage.ENGLISH -> "Sad"
        AppLanguage.ARABIC -> "Sad"
    }

    val bgmTagSleep: String get() = when (lang) {
        AppLanguage.CHINESE -> "Sleep"
        AppLanguage.ENGLISH -> "Sleep"
        AppLanguage.ARABIC -> "Sleep"
    }

    val bgmTagStudy: String get() = when (lang) {
        AppLanguage.CHINESE -> "Study"
        AppLanguage.ENGLISH -> "Study"
        AppLanguage.ARABIC -> "Study"
    }

    val bgmTagWorkout: String get() = when (lang) {
        AppLanguage.CHINESE -> "Workout"
        AppLanguage.ENGLISH -> "Workout"
        AppLanguage.ARABIC -> "Workout"
    }

    val blobDownloadHandledInternally: String get() = when (lang) {
        AppLanguage.CHINESE -> "Blob download handled internally"
        AppLanguage.ENGLISH -> "Blob download handled internally"
        AppLanguage.ARABIC -> "Blob download handled internally"
    }

    val buildOutputMissing: String get() = when (lang) {
        AppLanguage.CHINESE -> "Build output missing: %s"
        AppLanguage.ENGLISH -> "Build output missing: %s"
        AppLanguage.ARABIC -> "Build output missing: %s"
    }

    val checkFailed: String get() = when (lang) {
        AppLanguage.CHINESE -> "Check failed"
        AppLanguage.ENGLISH -> "Check failed"
        AppLanguage.ARABIC -> "Check failed"
    }

    val checkPassed: String get() = when (lang) {
        AppLanguage.CHINESE -> "Check passed"
        AppLanguage.ENGLISH -> "Check passed"
        AppLanguage.ARABIC -> "Check passed"
    }

    val chooseBrowser: String get() = when (lang) {
        AppLanguage.CHINESE -> "Choose browser"
        AppLanguage.ENGLISH -> "Choose browser"
        AppLanguage.ARABIC -> "Choose browser"
    }

    val codeFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "Code"
        AppLanguage.ENGLISH -> "Code"
        AppLanguage.ARABIC -> "Code"
    }

    val configureAiModelsHint: String get() = when (lang) {
        AppLanguage.CHINESE -> "Configure AI models in settings"
        AppLanguage.ENGLISH -> "Configure AI models in settings"
        AppLanguage.ARABIC -> "Configure AI models in settings"
    }

    val configureModuleDevModelHint: String get() = when (lang) {
        AppLanguage.CHINESE -> "Configure a model for module development"
        AppLanguage.ENGLISH -> "Configure a model for module development"
        AppLanguage.ARABIC -> "Configure a model for module development"
    }

    val console: String get() = when (lang) {
        AppLanguage.CHINESE -> "Console"
        AppLanguage.ENGLISH -> "Console"
        AppLanguage.ARABIC -> "Console"
    }

    val copyAll: String get() = when (lang) {
        AppLanguage.CHINESE -> "Copy all"
        AppLanguage.ENGLISH -> "Copy all"
        AppLanguage.ARABIC -> "Copy all"
    }

    val createCategoryFailed: String get() = when (lang) {
        AppLanguage.CHINESE -> "Create category failed: %s"
        AppLanguage.ENGLISH -> "Create category failed: %s"
        AppLanguage.ARABIC -> "Create category failed: %s"
    }

    val createFailedWithReason: String get() = when (lang) {
        AppLanguage.CHINESE -> "Create failed: %s"
        AppLanguage.ENGLISH -> "Create failed: %s"
        AppLanguage.ARABIC -> "Create failed: %s"
    }

    val dataUrlDownloadHandledInternally: String get() = when (lang) {
        AppLanguage.CHINESE -> "Data URL download handled internally"
        AppLanguage.ENGLISH -> "Data URL download handled internally"
        AppLanguage.ARABIC -> "Data URL download handled internally"
    }

    val deleteCategoryFailed: String get() = when (lang) {
        AppLanguage.CHINESE -> "Delete category failed: %s"
        AppLanguage.ENGLISH -> "Delete category failed: %s"
        AppLanguage.ARABIC -> "Delete category failed: %s"
    }

    val deleteFailed: String get() = when (lang) {
        AppLanguage.CHINESE -> "Delete failed"
        AppLanguage.ENGLISH -> "Delete failed"
        AppLanguage.ARABIC -> "Delete failed"
    }

    val developerTools: String get() = when (lang) {
        AppLanguage.CHINESE -> "Developer tools"
        AppLanguage.ENGLISH -> "Developer tools"
        AppLanguage.ARABIC -> "Developer tools"
    }

    val downloadNotificationsDescription: String get() = when (lang) {
        AppLanguage.CHINESE -> "Download in progress"
        AppLanguage.ENGLISH -> "Download in progress"
        AppLanguage.ARABIC -> "Download in progress"
    }

    val downloadNotificationsTitle: String get() = when (lang) {
        AppLanguage.CHINESE -> "Downloads"
        AppLanguage.ENGLISH -> "Downloads"
        AppLanguage.ARABIC -> "Downloads"
    }

    val downloadingEllipsis: String get() = when (lang) {
        AppLanguage.CHINESE -> "Downloading..."
        AppLanguage.ENGLISH -> "Downloading..."
        AppLanguage.ARABIC -> "Downloading..."
    }

    val downloadingFileFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "Downloading %s"
        AppLanguage.ENGLISH -> "Downloading %s"
        AppLanguage.ARABIC -> "Downloading %s"
    }

    val downloadingFilesFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "Downloading %d files"
        AppLanguage.ENGLISH -> "Downloading %d files"
        AppLanguage.ARABIC -> "Downloading %d files"
    }

    val errorCodeFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "Error code: %s"
        AppLanguage.ENGLISH -> "Error code: %s"
        AppLanguage.ARABIC -> "Error code: %s"
    }

    val errorTypeAuth: String get() = when (lang) {
        AppLanguage.CHINESE -> "Authentication error"
        AppLanguage.ENGLISH -> "Authentication error"
        AppLanguage.ARABIC -> "Authentication error"
    }

    val errorTypeFatal: String get() = when (lang) {
        AppLanguage.CHINESE -> "Fatal error"
        AppLanguage.ENGLISH -> "Fatal error"
        AppLanguage.ARABIC -> "Fatal error"
    }

    val errorTypeNetwork: String get() = when (lang) {
        AppLanguage.CHINESE -> "Network error"
        AppLanguage.ENGLISH -> "Network error"
        AppLanguage.ARABIC -> "Network error"
    }

    val errorTypeOperationFailed: String get() = when (lang) {
        AppLanguage.CHINESE -> "Operation failed"
        AppLanguage.ENGLISH -> "Operation failed"
        AppLanguage.ARABIC -> "Operation failed"
    }

    val errorTypeParse: String get() = when (lang) {
        AppLanguage.CHINESE -> "Parse error"
        AppLanguage.ENGLISH -> "Parse error"
        AppLanguage.ARABIC -> "Parse error"
    }

    val errorTypeRateLimit: String get() = when (lang) {
        AppLanguage.CHINESE -> "Rate limit"
        AppLanguage.ENGLISH -> "Rate limit"
        AppLanguage.ARABIC -> "Rate limit"
    }

    val errorTypeResponseParse: String get() = when (lang) {
        AppLanguage.CHINESE -> "Response parse error"
        AppLanguage.ENGLISH -> "Response parse error"
        AppLanguage.ARABIC -> "Response parse error"
    }

    val errorTypeServer: String get() = when (lang) {
        AppLanguage.CHINESE -> "Server error"
        AppLanguage.ENGLISH -> "Server error"
        AppLanguage.ARABIC -> "Server error"
    }

    val errorTypeTimeout: String get() = when (lang) {
        AppLanguage.CHINESE -> "Timeout"
        AppLanguage.ENGLISH -> "Timeout"
        AppLanguage.ARABIC -> "Timeout"
    }

    val executionCompletedFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "Completed in %s"
        AppLanguage.ENGLISH -> "Completed in %s"
        AppLanguage.ARABIC -> "Completed in %s"
    }

    val failMark: String get() = when (lang) {
        AppLanguage.CHINESE -> "FAIL"
        AppLanguage.ENGLISH -> "FAIL"
        AppLanguage.ARABIC -> "FAIL"
    }

    val fileLineSizeFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "%d lines / %s"
        AppLanguage.ENGLISH -> "%d lines / %s"
        AppLanguage.ARABIC -> "%d lines / %s"
    }

    val frameworkAppCreated: String get() = when (lang) {
        AppLanguage.CHINESE -> "%s app created"
        AppLanguage.ENGLISH -> "%s app created"
        AppLanguage.ARABIC -> "%s app created"
    }

    val frameworkAppName: String get() = when (lang) {
        AppLanguage.CHINESE -> "%s App"
        AppLanguage.ENGLISH -> "%s App"
        AppLanguage.ARABIC -> "%s App"
    }

    val generating: String get() = when (lang) {
        AppLanguage.CHINESE -> "Generating..."
        AppLanguage.ENGLISH -> "Generating..."
        AppLanguage.ARABIC -> "Generating..."
    }

    val hideRawResponse: String get() = when (lang) {
        AppLanguage.CHINESE -> "Hide raw response"
        AppLanguage.ENGLISH -> "Hide raw response"
        AppLanguage.ARABIC -> "Hide raw response"
    }

    val home: String get() = when (lang) {
        AppLanguage.CHINESE -> "Home"
        AppLanguage.ENGLISH -> "Home"
        AppLanguage.ARABIC -> "Home"
    }

    val htmlAppCreated: String get() = when (lang) {
        AppLanguage.CHINESE -> "HTML app created"
        AppLanguage.ENGLISH -> "HTML app created"
        AppLanguage.ARABIC -> "HTML app created"
    }

    val htmlAppName: String get() = when (lang) {
        AppLanguage.CHINESE -> "HTML App"
        AppLanguage.ENGLISH -> "HTML App"
        AppLanguage.ARABIC -> "HTML App"
    }

    val htmlFileRequired: String get() = when (lang) {
        AppLanguage.CHINESE -> "HTML file required"
        AppLanguage.ENGLISH -> "HTML file required"
        AppLanguage.ARABIC -> "HTML file required"
    }

    val iconSaveFailed: String get() = when (lang) {
        AppLanguage.CHINESE -> "Failed to save icon"
        AppLanguage.ENGLISH -> "Failed to save icon"
        AppLanguage.ARABIC -> "Failed to save icon"
    }

    val imageAppName: String get() = when (lang) {
        AppLanguage.CHINESE -> "Image App"
        AppLanguage.ENGLISH -> "Image App"
        AppLanguage.ARABIC -> "Image App"
    }

    val jsConsoleInputHint: String get() = when (lang) {
        AppLanguage.CHINESE -> "Enter JavaScript and run"
        AppLanguage.ENGLISH -> "Enter JavaScript and run"
        AppLanguage.ARABIC -> "Enter JavaScript and run"
    }

    val legalAgreementContent: String get() = when (lang) {
        AppLanguage.CHINESE -> "By using this app, you agree to the terms."
        AppLanguage.ENGLISH -> "By using this app, you agree to the terms."
        AppLanguage.ARABIC -> "By using this app, you agree to the terms."
    }

    val legalAgreementTitle: String get() = when (lang) {
        AppLanguage.CHINESE -> "User Agreement"
        AppLanguage.ENGLISH -> "User Agreement"
        AppLanguage.ARABIC -> "User Agreement"
    }

    val legalEffectiveStatement: String get() = when (lang) {
        AppLanguage.CHINESE -> "Effective immediately"
        AppLanguage.ENGLISH -> "Effective immediately"
        AppLanguage.ARABIC -> "Effective immediately"
    }

    val legalNoticeIntro: String get() = when (lang) {
        AppLanguage.CHINESE -> "Legal Notice"
        AppLanguage.ENGLISH -> "Legal Notice"
        AppLanguage.ARABIC -> "Legal Notice"
    }

    val legalSection1Content: String get() = when (lang) {
        AppLanguage.CHINESE -> "Section 1 content."
        AppLanguage.ENGLISH -> "Section 1 content."
        AppLanguage.ARABIC -> "Section 1 content."
    }

    val legalSection1Title: String get() = when (lang) {
        AppLanguage.CHINESE -> "Section 1"
        AppLanguage.ENGLISH -> "Section 1"
        AppLanguage.ARABIC -> "Section 1"
    }

    val legalSection2Content: String get() = when (lang) {
        AppLanguage.CHINESE -> "Section 2 content."
        AppLanguage.ENGLISH -> "Section 2 content."
        AppLanguage.ARABIC -> "Section 2 content."
    }

    val legalSection2Title: String get() = when (lang) {
        AppLanguage.CHINESE -> "Section 2"
        AppLanguage.ENGLISH -> "Section 2"
        AppLanguage.ARABIC -> "Section 2"
    }

    val legalSection3Content: String get() = when (lang) {
        AppLanguage.CHINESE -> "Section 3 content."
        AppLanguage.ENGLISH -> "Section 3 content."
        AppLanguage.ARABIC -> "Section 3 content."
    }

    val legalSection3Title: String get() = when (lang) {
        AppLanguage.CHINESE -> "Section 3"
        AppLanguage.ENGLISH -> "Section 3"
        AppLanguage.ARABIC -> "Section 3"
    }

    val legalSection4Content: String get() = when (lang) {
        AppLanguage.CHINESE -> "Section 4 content."
        AppLanguage.ENGLISH -> "Section 4 content."
        AppLanguage.ARABIC -> "Section 4 content."
    }

    val legalSection4Title: String get() = when (lang) {
        AppLanguage.CHINESE -> "Section 4"
        AppLanguage.ENGLISH -> "Section 4"
        AppLanguage.ARABIC -> "Section 4"
    }

    val legalSection5Content: String get() = when (lang) {
        AppLanguage.CHINESE -> "Section 5 content."
        AppLanguage.ENGLISH -> "Section 5 content."
        AppLanguage.ARABIC -> "Section 5 content."
    }

    val legalSection5Title: String get() = when (lang) {
        AppLanguage.CHINESE -> "Section 5"
        AppLanguage.ENGLISH -> "Section 5"
        AppLanguage.ARABIC -> "Section 5"
    }

    val legalSection6Content: String get() = when (lang) {
        AppLanguage.CHINESE -> "Section 6 content."
        AppLanguage.ENGLISH -> "Section 6 content."
        AppLanguage.ARABIC -> "Section 6 content."
    }

    val legalSection6Title: String get() = when (lang) {
        AppLanguage.CHINESE -> "Section 6"
        AppLanguage.ENGLISH -> "Section 6"
        AppLanguage.ARABIC -> "Section 6"
    }

    val levelLabel: String get() = when (lang) {
        AppLanguage.CHINESE -> "Level"
        AppLanguage.ENGLISH -> "Level"
        AppLanguage.ARABIC -> "Level"
    }

    val lineCountFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "%d lines"
        AppLanguage.ENGLISH -> "%d lines"
        AppLanguage.ARABIC -> "%d lines"
    }

    val listSeparator: String get() = when (lang) {
        AppLanguage.CHINESE -> ", "
        AppLanguage.ENGLISH -> ", "
        AppLanguage.ARABIC -> ", "
    }
    ...
    val logDetails: String get() = when (lang) {
        AppLanguage.CHINESE -> "Log details"
        AppLanguage.ENGLISH -> "Log details"
        AppLanguage.ARABIC -> "Log details"
    }

    val mediaAppCreated: String get() = when (lang) {
        AppLanguage.CHINESE -> "Media app created"
        AppLanguage.ENGLISH -> "Media app created"
        AppLanguage.ARABIC -> "Media app created"
    }

    val mediaPathRequired: String get() = when (lang) {
        AppLanguage.CHINESE -> "Media path required"
        AppLanguage.ENGLISH -> "Media path required"
        AppLanguage.ARABIC -> "Media path required"
    }

    val mediaSaveFailed: String get() = when (lang) {
        AppLanguage.CHINESE -> "Failed to save media"
        AppLanguage.ENGLISH -> "Failed to save media"
        AppLanguage.ARABIC -> "Failed to save media"
    }

    val messageContentLabel: String get() = when (lang) {
        AppLanguage.CHINESE -> "Content"
        AppLanguage.ENGLISH -> "Content"
        AppLanguage.ARABIC -> "Content"
    }

    val messageLabel: String get() = when (lang) {
        AppLanguage.CHINESE -> "Message"
        AppLanguage.ENGLISH -> "Message"
        AppLanguage.ARABIC -> "Message"
    }

    val moduleSavedSuccess: String get() = when (lang) {
        AppLanguage.CHINESE -> "Module saved"
        AppLanguage.ENGLISH -> "Module saved"
        AppLanguage.ARABIC -> "Module saved"
    }

    val moduleTestTitle: String get() = when (lang) {
        AppLanguage.CHINESE -> "Module test"
        AppLanguage.ENGLISH -> "Module test"
        AppLanguage.ARABIC -> "Module test"
    }

    val moveFailed: String get() = when (lang) {
        AppLanguage.CHINESE -> "Move failed: %s"
        AppLanguage.ENGLISH -> "Move failed: %s"
        AppLanguage.ARABIC -> "Move failed: %s"
    }

    val navForward: String get() = when (lang) {
        AppLanguage.CHINESE -> "Forward"
        AppLanguage.ENGLISH -> "Forward"
        AppLanguage.ARABIC -> "Forward"
    }

    val newMessageLabel: String get() = when (lang) {
        AppLanguage.CHINESE -> "New message"
        AppLanguage.ENGLISH -> "New message"
        AppLanguage.ARABIC -> "New message"
    }

    val noAvailableModels: String get() = when (lang) {
        AppLanguage.CHINESE -> "No available models"
        AppLanguage.ENGLISH -> "No available models"
        AppLanguage.ARABIC -> "No available models"
    }

    val noCodeToVerify: String get() = when (lang) {
        AppLanguage.CHINESE -> "No code to verify"
        AppLanguage.ENGLISH -> "No code to verify"
        AppLanguage.ARABIC -> "No code to verify"
    }

    val noConsoleMessages: String get() = when (lang) {
        AppLanguage.CHINESE -> "No console messages"
        AppLanguage.ENGLISH -> "No console messages"
        AppLanguage.ARABIC -> "No console messages"
    }

    val noModelConfigured: String get() = when (lang) {
        AppLanguage.CHINESE -> "No model configured"
        AppLanguage.ENGLISH -> "No model configured"
        AppLanguage.ARABIC -> "No model configured"
    }

    val noOtherModels: String get() = when (lang) {
        AppLanguage.CHINESE -> "No other models"
        AppLanguage.ENGLISH -> "No other models"
        AppLanguage.ARABIC -> "No other models"
    }

    val noReturnValue: String get() = when (lang) {
        AppLanguage.CHINESE -> "No return value"
        AppLanguage.ENGLISH -> "No return value"
        AppLanguage.ARABIC -> "No return value"
    }

    val offlineHint: String get() = when (lang) {
        AppLanguage.CHINESE -> "Check your connection and try again"
        AppLanguage.ENGLISH -> "Check your connection and try again"
        AppLanguage.ARABIC -> "Check your connection and try again"
    }

    val offlineTitle: String get() = when (lang) {
        AppLanguage.CHINESE -> "Offline"
        AppLanguage.ENGLISH -> "Offline"
        AppLanguage.ARABIC -> "Offline"
    }

    val parametersLabel: String get() = when (lang) {
        AppLanguage.CHINESE -> "Parameters"
        AppLanguage.ENGLISH -> "Parameters"
        AppLanguage.ARABIC -> "Parameters"
    }

    val passMark: String get() = when (lang) {
        AppLanguage.CHINESE -> "PASS"
        AppLanguage.ENGLISH -> "PASS"
        AppLanguage.ARABIC -> "PASS"
    }

    val previewReadFileFailed: String get() = when (lang) {
        AppLanguage.CHINESE -> "Failed to read file for preview"
        AppLanguage.ENGLISH -> "Failed to read file for preview"
        AppLanguage.ARABIC -> "Failed to read file for preview"
    }

    val rateLimitTitle: String get() = when (lang) {
        AppLanguage.CHINESE -> "Rate limit reached"
        AppLanguage.ENGLISH -> "Rate limit reached"
        AppLanguage.ARABIC -> "Rate limit reached"
    }

    val readFile: String get() = when (lang) {
        AppLanguage.CHINESE -> "Read file"
        AppLanguage.ENGLISH -> "Read file"
        AppLanguage.ARABIC -> "Read file"
    }

    val recoverable: String get() = when (lang) {
        AppLanguage.CHINESE -> "Recoverable"
        AppLanguage.ENGLISH -> "Recoverable"
        AppLanguage.ARABIC -> "Recoverable"
    }

    val restoreSessionFailed: String get() = when (lang) {
        AppLanguage.CHINESE -> "Restore session failed: %s"
        AppLanguage.ENGLISH -> "Restore session failed: %s"
        AppLanguage.ARABIC -> "Restore session failed: %s"
    }

    val resultCountFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "%d results"
        AppLanguage.ENGLISH -> "%d results"
        AppLanguage.ARABIC -> "%d results"
    }

    val resultLabel: String get() = when (lang) {
        AppLanguage.CHINESE -> "Result"
        AppLanguage.ENGLISH -> "Result"
        AppLanguage.ARABIC -> "Result"
    }

    val retryAfterSeconds: String get() = when (lang) {
        AppLanguage.CHINESE -> "Retry after %d s"
        AppLanguage.ENGLISH -> "Retry after %d s"
        AppLanguage.ARABIC -> "Retry after %d s"
    }

    val retrying: String get() = when (lang) {
        AppLanguage.CHINESE -> "Retrying..."
        AppLanguage.ENGLISH -> "Retrying..."
        AppLanguage.ARABIC -> "Retrying..."
    }

    val selectedImage: String get() = when (lang) {
        AppLanguage.CHINESE -> "Selected image"
        AppLanguage.ENGLISH -> "Selected image"
        AppLanguage.ARABIC -> "Selected image"
    }

    val sessionAbandoned: String get() = when (lang) {
        AppLanguage.CHINESE -> "Session abandoned"
        AppLanguage.ENGLISH -> "Session abandoned"
        AppLanguage.ARABIC -> "Session abandoned"
    }

    val sessionRestored: String get() = when (lang) {
        AppLanguage.CHINESE -> "Session restored"
        AppLanguage.ENGLISH -> "Session restored"
        AppLanguage.ARABIC -> "Session restored"
    }

    val sourceCodeTitle: String get() = when (lang) {
        AppLanguage.CHINESE -> "Source code"
        AppLanguage.ENGLISH -> "Source code"
        AppLanguage.ARABIC -> "Source code"
    }

    val sourceLabel: String get() = when (lang) {
        AppLanguage.CHINESE -> "Source"
        AppLanguage.ENGLISH -> "Source"
        AppLanguage.ARABIC -> "Source"
    }

    val splashSaveFailed: String get() = when (lang) {
        AppLanguage.CHINESE -> "Failed to save splash screen"
        AppLanguage.ENGLISH -> "Failed to save splash screen"
        AppLanguage.ARABIC -> "Failed to save splash screen"
    }

    val sslSecurityError: String get() = when (lang) {
        AppLanguage.CHINESE -> "SSL security error"
        AppLanguage.ENGLISH -> "SSL security error"
        AppLanguage.ARABIC -> "SSL security error"
    }

    val start: String get() = when (lang) {
        AppLanguage.CHINESE -> "Start"
        AppLanguage.ENGLISH -> "Start"
        AppLanguage.ARABIC -> "Start"
    }

    val staticWebsite: String get() = when (lang) {
        AppLanguage.CHINESE -> "Static website"
        AppLanguage.ENGLISH -> "Static website"
        AppLanguage.ARABIC -> "Static website"
    }

    val statusWaiting: String get() = when (lang) {
        AppLanguage.CHINESE -> "Waiting"
        AppLanguage.ENGLISH -> "Waiting"
        AppLanguage.ARABIC -> "Waiting"
    }

    val switchedToModel: String get() = when (lang) {
        AppLanguage.CHINESE -> "Switched to %s"
        AppLanguage.ENGLISH -> "Switched to %s"
        AppLanguage.ARABIC -> "Switched to %s"
    }

    val testModuleCount: String get() = when (lang) {
        AppLanguage.CHINESE -> "Testing %d modules"
        AppLanguage.ENGLISH -> "Testing %d modules"
        AppLanguage.ARABIC -> "Testing %d modules"
    }

    val timeLabel: String get() = when (lang) {
        AppLanguage.CHINESE -> "Time"
        AppLanguage.ENGLISH -> "Time"
        AppLanguage.ARABIC -> "Time"
    }

    val updateCategoryFailed: String get() = when (lang) {
        AppLanguage.CHINESE -> "Update category failed: %s"
        AppLanguage.ENGLISH -> "Update category failed: %s"
        AppLanguage.ARABIC -> "Update category failed: %s"
    }

    val urlInvalid: String get() = when (lang) {
        AppLanguage.CHINESE -> "Invalid URL"
        AppLanguage.ENGLISH -> "Invalid URL"
        AppLanguage.ARABIC -> "Invalid URL"
    }

    val urlRequired: String get() = when (lang) {
        AppLanguage.CHINESE -> "URL required"
        AppLanguage.ENGLISH -> "URL required"
        AppLanguage.ARABIC -> "URL required"
    }

    val validate: String get() = when (lang) {
        AppLanguage.CHINESE -> "Validate"
        AppLanguage.ENGLISH -> "Validate"
        AppLanguage.ARABIC -> "Validate"
    }

    val videoAppName: String get() = when (lang) {
        AppLanguage.CHINESE -> "Video App"
        AppLanguage.ENGLISH -> "Video App"
        AppLanguage.ARABIC -> "Video App"
    }

    val viewSource: String get() = when (lang) {
        AppLanguage.CHINESE -> "View source"
        AppLanguage.ENGLISH -> "View source"
        AppLanguage.ARABIC -> "View source"
    }

    val webAppCopyNameFormat: String get() = when (lang) {
        AppLanguage.CHINESE -> "%s (Copy)"
        AppLanguage.ENGLISH -> "%s (Copy)"
        AppLanguage.ARABIC -> "%s (Copy)"
    }

    val webSearch: String get() = when (lang) {
        AppLanguage.CHINESE -> "Web search"
        AppLanguage.ENGLISH -> "Web search"
        AppLanguage.ARABIC -> "Web search"
    }

    val writeFile: String get() = when (lang) {
        AppLanguage.CHINESE -> "Write file"
        AppLanguage.ENGLISH -> "Write file"
        AppLanguage.ARABIC -> "Write file"
    }

    val you: String get() = when (lang) {
        AppLanguage.CHINESE -> "You"
        AppLanguage.ENGLISH -> "You"
        AppLanguage.ARABIC -> "You"
    }
}
