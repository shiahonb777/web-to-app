...
new MutationObserver(addImageDownloadButtons)
    ...
    private fun domOperations() = CodeSnippetCategory(
        ...
        name = "DOM 操作",
        icon = "🔧",
        description = "页面元素的查询、修改、创建和删除",
        snippets = listOf(
            CodeSnippet(
                id = "dom-query-single",
                name = "查询单个元素",
                description = "使用 CSS 选择器查询单个元素",
...
if (element) {
    // 对元素进行操作
            ...
            CodeSnippet(
                id = "dom-query-all",
                name = "查询所有元素",
                description = "使用 CSS 选择器查询所有匹配元素",
...
replaceElement('.old-class', '<div class="new-class">新内容</div>');""",
    ...
    private fun styleOperations() = CodeSnippetCategory(
        ...
        name = "样式操作",
        icon = "🎨",
        description = "CSS 样式的注入、修改和动态控制",
        snippets = listOf(
            CodeSnippet(
                id = "style-inject-css",
                name = "注入 CSS 样式",
                description = "向页面注入自定义 CSS",
...
document.head.appendChild(style);""",
    ...
    private fun eventListeners() = CodeSnippetCategory(
        ...
        name = "事件监听",
        icon = "👆",
        description = "各种用户交互和页面事件的监听",
        snippets = listOf(
            CodeSnippet(
                id = "event-click",
                name = "点击事件",
                description = "监听元素点击事件",
    ...
    if (scrollTop > 300) {
        // 显示返回顶部按钮
            ...
            CodeSnippet(
                id = "event-mutation",
                name = "DOM 变化监听",
                description = "监听 DOM 结构变化，适合处理动态加载内容",
...
document.addEventListener('touchmove', () => {
    ...
    private fun storageOperations() = CodeSnippetCategory(
        ...
        name = "存储操作",
        icon = "💾",
        description = "本地存储、Cookie 等数据存储操作",
        snippets = listOf(
            CodeSnippet(
                id = "storage-local-set",
                name = "保存到本地存储",
                description = "将数据保存到 localStorage",
...
const data = loadData('myKey', {});""",
            ...
            CodeSnippet(
                id = "storage-session",
                name = "会话存储",
                description = "使用 sessionStorage 临时存储",
                code = """// 保存（页面关闭后清除）
...
deleteCookie('myCookie');""",
            ...
            CodeSnippet(
                ...
                name = "IndexedDB 存储",
                description = "使用 IndexedDB 存储大量数据",
...
function downloadBlob(blob, filename) {
    ...
    private fun dataProcessing() = CodeSnippetCategory(
        ...
        name = "数据处理",
        icon = "📊",
        description = "数据提取、转换、导出等操作",
        snippets = listOf(
            CodeSnippet(
                id = "data-extract-table",
                name = "提取表格数据",
                description = "将 HTML 表格转换为 JSON",
...
const url = buildUrl('https://example.com/search', { q: 'test', page: 1 });""",
    ...
    private fun uiComponents() = CodeSnippetCategory(
        ...
        name = "UI 组件",
        icon = "🎯",
        description = "悬浮按钮、弹窗、提示等 UI 组件",
        snippets = listOf(
            CodeSnippet(
                id = "ui-floating-button",
                name = "悬浮按钮",
                description = "创建一个悬浮操作按钮",
...
showSnackbar('文件已删除', '撤销', () => console.log('撤销'));""",
    ...
    private fun floatingWidgets() = CodeSnippetCategory(
        ...
        name = "悬浮组件",
        icon = "🔲",
        description = "悬浮面板、工具栏、侧边栏等",
        snippets = listOf(
            CodeSnippet(
                id = "widget-toolbar",
                name = "悬浮工具栏",
                description = "创建可拖动的悬浮工具栏",
...
// makeDraggable(document.querySelector('.my-widget'));""",
    ...
    private fun notifications() = CodeSnippetCategory(
        ...
        name = "通知系统",
        icon = "🔔",
        description = "各种通知和提醒功能",
        snippets = listOf(
            CodeSnippet(
                id = "notif-browser",
                name = "浏览器通知",
                description = "发送浏览器原生通知",
...
addPasswordToggle('#password');""",
    ...
    private fun mediaOperations() = CodeSnippetCategory(
        ...
        name = "媒体操作",
        icon = "🎬",
        description = "视频、音频、图片等媒体控制",
        snippets = listOf(
            CodeSnippet(
                id = "media-video-speed",
                name = "视频倍速控制",
                description = "控制视频播放速度",
...
function videoFullscreen() {
    ...
    private fun pageEnhance() = CodeSnippetCategory(
        ...
        name = "页面增强",
        icon = "✨",
        description = "页面功能增强和优化",
        snippets = listOf(
            CodeSnippet(
                id = "enhance-reading-mode",
                name = "阅读模式",
                description = "提取正文，简化页面",
...
highlightText('搜索关键词');""",
    ...
    private fun contentFilter() = CodeSnippetCategory(
        ...
        name = "内容过滤",
        icon = "🔍",
        description = "过滤和筛选页面内容",
        snippets = listOf(
            CodeSnippet(
                id = "filter-keywords",
                name = "关键词过滤",
                description = "隐藏包含特定关键词的元素",
...
observer.observe(document.body, { childList: true, subtree: true });""",
    ...
    private fun utilityFunctions() = CodeSnippetCategory(
        ...
        name = "工具函数",
        icon = "🔨",
        description = "常用的工具函数和辅助方法",
        snippets = listOf(
            CodeSnippet(
                id = "util-debounce",
                name = "防抖函数",
                description = "限制函数执行频率（延迟执行）",
...
retry(() => fetch('/api/data').then(r => r.json()), 3, 1000);""",
    ...
    private fun textProcessing() = CodeSnippetCategory(
        ...
        name = "文本处理",
        icon = "📄",
        description = "文本提取、转换、处理",
        snippets = listOf(
            CodeSnippet(
                id = "text-extract-article",
                name = "提取文章正文",
                description = "智能提取页面正文内容",
...
window.fetch = async function(url, options = {}) {
    ...
    return response;
            ...
            CodeSnippet(
                id = "intercept-xhr",
                name = "拦截 XHR 请求",
                description = "拦截 XMLHttpRequest 请求",
