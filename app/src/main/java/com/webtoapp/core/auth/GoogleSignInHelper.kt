...
object GoogleSignInHelper {
    ...
    fun hasPendingOAuth(): Boolean {
        return pendingOAuthCallback != null
    }

    fun cancelPendingOAuth(): Boolean {
        val callback = pendingOAuthCallback ?: return false
        cleanup()
        AppLogger.i(TAG, "Web OAuth flow cancelled after returning to app")
