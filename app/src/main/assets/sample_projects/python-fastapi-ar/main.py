...
<div class="c">
<div class="hdr">
    <div><h1>⚡ FastAPI Monitor</h1><p>مراقب API عالي الأداء</p></div>
    <div class="badge"><span class="dot"></span>متصل</div>
</div>
<div class="row">
    <div class="m"><div class="m-val" id="uptime">0s</div><div class="m-label">وقت التشغيل</div></div>
    <div class="m"><div class="m-val" id="reqCount">0</div><div class="m-label">الطلبات</div></div>
    <div class="m"><div class="m-val" id="avgMs">&lt;1ms</div><div class="m-label">متوسط التأخير</div></div>
</div>
<div class="card">
    <div class="card-h"><span class="card-t">نقاط API</span><span class="card-b">6 مسارات</span></div>
    <div class="endpoint"><span class="method get">GET</span><div class="ep-info"><div class="ep-path">/</div><div class="ep-desc">الصفحة الرئيسية</div></div><div class="ep-ms">&lt;1ms</div></div>
    <div class="endpoint"><span class="method get">GET</span><div class="ep-info"><div class="ep-path">/api/books</div><div class="ep-desc">قائمة الكتب</div></div><div class="ep-ms">~2ms</div></div>
    <div class="endpoint"><span class="method get">GET</span><div class="ep-info"><div class="ep-path">/api/books/{id}</div><div class="ep-desc">كتاب محدد</div></div><div class="ep-ms">~1ms</div></div>
    <div class="endpoint"><span class="method post">POST</span><div class="ep-info"><div class="ep-path">/api/books</div><div class="ep-desc">إضافة كتاب</div></div><div class="ep-ms">~3ms</div></div>
    <div class="endpoint"><span class="method get">GET</span><div class="ep-info"><div class="ep-path">/api/health</div><div class="ep-desc">فحص الصحة</div></div><div class="ep-ms">&lt;1ms</div></div>
    <div class="endpoint"><span class="method get">GET</span><div class="ep-info"><div class="ep-path">/docs</div><div class="ep-desc">مستندات Swagger</div></div><div class="ep-ms">تلقائي</div></div>
</div>
<div class="card">
    <div class="card-h"><span class="card-t">اختبار مباشر</span><span class="card-b">🧪 تفاعلي</span></div>
    <div style="display:flex;gap:8px;flex-wrap:wrap">
        <button class="try-btn" onclick="tryApi('/api/books')">📚 الكتب</button>
        <button class="try-btn" onclick="tryApi('/api/health')">💚 فحص الصحة</button>
        <button class="try-btn" onclick="tryApi('/api/books/1')">🔍 تفاصيل</button>
    </div>
    <div class="result" id="result"></div>
</div>
<div class="card">
    <div class="card-h"><span class="card-t">المقاييس</span><span class="card-b">📊 مباشر</span></div>
