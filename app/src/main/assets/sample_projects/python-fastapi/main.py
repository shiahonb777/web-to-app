...
<div class="c">
<div class="hdr">
    <div><h1>⚡ FastAPI Monitor</h1><p>高性能 API 监控仪表盘</p></div>
    <div class="badge"><span class="dot"></span>在线</div>
</div>
<div class="row">
    <div class="m"><div class="m-val" id="uptime">0s</div><div class="m-label">运行时间</div></div>
    <div class="m"><div class="m-val" id="reqCount">0</div><div class="m-label">请求数</div></div>
    <div class="m"><div class="m-val" id="avgMs">&lt;1ms</div><div class="m-label">平均延迟</div></div>
</div>
<div class="card">
    <div class="card-h"><span class="card-t">API 端点</span><span class="card-b">6 个路由</span></div>
    <div class="endpoint"><span class="method get">GET</span><div class="ep-info"><div class="ep-path">/</div><div class="ep-desc">仪表盘首页</div></div><div class="ep-ms">&lt;1ms</div></div>
    <div class="endpoint"><span class="method get">GET</span><div class="ep-info"><div class="ep-path">/api/books</div><div class="ep-desc">获取所有书籍</div></div><div class="ep-ms">~2ms</div></div>
    <div class="endpoint"><span class="method get">GET</span><div class="ep-info"><div class="ep-path">/api/books/{id}</div><div class="ep-desc">获取指定书籍</div></div><div class="ep-ms">~1ms</div></div>
    <div class="endpoint"><span class="method post">POST</span><div class="ep-info"><div class="ep-path">/api/books</div><div class="ep-desc">添加新书籍</div></div><div class="ep-ms">~3ms</div></div>
    <div class="endpoint"><span class="method get">GET</span><div class="ep-info"><div class="ep-path">/api/health</div><div class="ep-desc">健康检查</div></div><div class="ep-ms">&lt;1ms</div></div>
    <div class="endpoint"><span class="method get">GET</span><div class="ep-info"><div class="ep-path">/docs</div><div class="ep-desc">Swagger 文档</div></div><div class="ep-ms">自动生成</div></div>
</div>
<div class="card">
    <div class="card-h"><span class="card-t">实时测试</span><span class="card-b">🧪 交互</span></div>
    <div style="display:flex;gap:8px;flex-wrap:wrap">
        <button class="try-btn" onclick="tryApi('/api/books')">📚 获取书籍</button>
        <button class="try-btn" onclick="tryApi('/api/health')">💚 健康检查</button>
        <button class="try-btn" onclick="tryApi('/api/books/1')">🔍 书籍详情</button>
    </div>
    <div class="result" id="result"></div>
</div>
<div class="card">
    <div class="card-h"><span class="card-t">性能指标</span><span class="card-b">📊 实时</span></div>
    ...
    <div class="bar-row"><span class="bar-label">内存</span><div class="bar-track"><div class="bar-fill" id="mem" style="width:0%;background:linear-gradient(90deg,var(--purple),#c084fc)"></div></div><span class="bar-val" id="memV">0%</span></div>
    <div class="bar-row"><span class="bar-label">磁盘</span><div class="bar-track"><div class="bar-fill" id="disk" style="width:0%;background:linear-gradient(90deg,var(--amber),#fbbf24)"></div></div><span class="bar-val" id="diskV">0%</span></div>
</div>
