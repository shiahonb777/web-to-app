...
**🔗 Links: [GitHub](https://github.com/shiahonb777/web-to-app) | [Gitee (China)](https://gitee.com/ashiahonb777/web-to-app) | [Website](https://shiaho.sbs)**
...
- **HTML to App**: Convert HTML/CSS/JS projects into standalone apps (v1.5.0)
...
- **Background Music**: Add BGM to apps with LRC lyrics sync (v1.5.0)
...
- AI HTML Coding Assistant: AI-powered code generation
  ...
  - Markdown Rendering: AI output supports headings, lists, tables, code blocks
  - Mermaid Charts: AI output supports flowcharts, sequence diagrams, class diagrams
- AI Settings: Unified API key and model management
...
- Theme System: Brand new theme customization
  ...
  - Theme Adaptation: Exported APK dialogs auto-adapt to user-selected theme
- Background Music (BGM): Add BGM with LRC lyrics sync
- Landscape Mode: WebView apps support forced landscape orientation, ideal for games/video sites
- Announcement Button: Custom button support in announcement dialog with configurable link (e.g., Join Official Group)
...
**Bug Fixes**
- Fixed APK installation failure when injecting JavaScript scripts (packageinfo null)
  - Root cause: JSON serialization didn't properly handle special characters in JavaScript code
  - Solution: Use Gson library for safe script data serialization
...
- **🌐 Website**: [shiaho.sbs](https://shiaho.sbs) | [Backup: shiaho.top](https://shiaho.top)
  - Leave messages on the website, author will update based on feedback
  - All author's works are showcased on the website
- **📦 Open Source**:
  - GitHub: https://github.com/shiahonb777/web-to-app
  - Gitee (China): https://gitee.com/ashiahonb777/web-to-app
- **QQ Group**: 1041130206
