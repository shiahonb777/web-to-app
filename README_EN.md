...
- Icon Library: Collect and manage generated icons
- Online Music Search: Search and download music online for BGM
- Gallery Mode: Multi-media carousel gallery
  - Support images/videos/HTML/web mixed
  - Autoplay, loop, transition animations
...
- Improved APK build process, support gallery mode packaging
